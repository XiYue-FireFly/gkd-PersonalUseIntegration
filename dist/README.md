...
|Blued|4|<li>局部广告-卡片广告<li>全屏广告-弹窗广告<li>全屏广告-会员活动弹窗<li>全屏广告-购买动态投放弹窗|
...
|CSDN|7|<li>开屏广告<li>更新提示<li>分段广告-信息流广告<li>评价提示-软件好评弹窗<li>全屏广告-弹窗广告<li>权限提示-通知权限<li>分段广告-底部广告|
...
|GPS JoyStick|3|<li>更新提示<li>全屏广告<li>开屏广告|
...
|JMComic2|5|<li>开屏广告<li>全屏广告<li>局部广告-底部横幅广告<li>功能类-路线选择<li>功能类-点击[我保证我已满18岁]|
|JMComic3|1|<li>全屏广告|
|Jump|3|<li>开屏广告<li>权限提示-通知权限<li>局部广告-信息流广告/卡片广告|
|Keep|5|<li>全屏广告-首页广告弹窗<li>局部广告-首页信息流广告<li>全屏广告-运动购页面广告弹窗<li>全屏广告-请求开启通知权限弹窗<li>更新提示|
|KMB . LWB|1|<li>开屏广告|
...
|TapTap|4|<li>开屏广告<li>分段广告-游戏浏览页面推荐广告<li>更新提示<li>青少年模式-首页顶部横幅提示|
...
|WPS|10|<li>分段广告-首页文档列表广告<li>全屏广告-弹窗广告<li>更新提示<li>全屏广告-关闭[开启WPS云服务]弹窗<li>分段广告-文档末尾广告<li>局部广告<li>局部广告-首页底部升级会员卡片<li>全屏广告-体验超级会员弹窗<li>功能类-自动签到<li>评价提示|
|WPS Office Lite|2|<li>全屏广告<li>权限提示-通知权限|
|X|8|<li>分段广告-信息流广告<li>全屏广告-关闭[开启个性化广告]弹窗<li>分段广告-用户资料页信息流广告<li>评价提示<li>权限提示-通知权限<li>功能类-自动点击翻译<li>功能类-自动点击"显示更多帖子"<li>其他-关闭[开启个性化广告]弹窗|
|Xfinity|1|<li>全屏广告|
|YouTube|1|<li>全屏广告-会员广告|
|YouTube|1|<li>功能类-关闭底部播放横条|
|YouTube|10|<li>全屏广告-视频播放-跳过广告<li>全屏广告-视频播放-赞助商广告<li>全屏广告-会员广告<li>局部广告-1<li>功能类-自动翻译评论<li>分段广告-播放页广告-1<li>其他-关闭播放器辅助功能弹窗<li>功能类-关闭视频播放结束后的推荐视频<li>局部广告-1-1-1-1<li>分段广告-播放页广告-1-1-1-1|
...
|123云盘|7|<li>全屏广告-弹窗广告<li>开屏广告<li>更新提示<li>功能类-扫码自动确认登录<li>全屏广告-相册自动备份弹窗<li>分段广告<li>局部广告|
...
|爱奇艺|6|<li>开屏广告<li>青少年模式-青少年弹窗<li>局部广告-顶部卡片广告<li>权限提示-通知权限<li>更新提示<li>全屏广告-播放页-插入广告|
|爱奇艺极速版|1|<li>开屏广告|
|爱奇艺体育|1|<li>开屏广告|
|爱奇艺PAD|2|<li>开屏广告<li>全屏广告-暂停播放后出现的广告|
|爱企查|3|<li>更新提示<li>权限提示-通知权限<li>其他-请求通知权限提示信息|
|爱山东|1|<li>开屏广告|
|爱玩机工具箱|1|<li>功能类-忽略授权提示|
|爱吾游戏宝盒|1|<li>青少年模式|
|安吉星|1|<li>开屏广告|
|安全服务/小米手机管家|10|<li>功能类-USB安装时自动继续安装<li>功能类-禁止获取定位<li>功能类-使用返回退出时直接点击[退出]<li>功能类-高敏感权限自动确定-1<li>功能类-高敏感权限自动确定-1-1-1-1<li>功能类-应用信息页-自启动提示<li>功能类-自动允许分享文件<li>功能类-自动关闭SIM卡安全保护验证提示<li>功能类-禁止后台运行弹窗<li>功能类-风险提示-仍然支付|
...
|百度百科|1|<li>权限提示-通知权限|
|百度地图|12|<li>开屏广告<li>局部广告-各类局部广告<li>局部广告-打车界面右侧悬浮球<li>全屏广告-各类弹窗广告<li>全屏广告-酒店提前订弹窗<li>权限提示-定位权限<li>全屏广告-打车界面弹窗广告<li>更新提示<li>权限提示-通知权限<li>功能类-通勤卡添加至桌面<li>全屏广告<li>局部广告|
|百度输入法|3|<li>全屏广告-创作祝福弹窗<li>局部广告-底部会员悬浮卡片<li>局部广告-皮肤试用页-卡片广告|
|百度输入法华为定制版|1|<li>开屏广告|
|百度贴吧|14|<li>开屏广告<li>通知提示-申请消息提醒弹窗<li>分段广告-信息流广告<li>局部广告-首页、推荐列表顶部卡片式广告<li>更新提示<li>分段广告-帖子底部内容推荐卡片<li>全屏广告-广告弹窗<li>局部广告-悬浮小广告<li>局部广告-[帖子内/吧内]底部悬浮窗<li>功能类-贴吧内签到并关闭弹窗<li>局部广告-感兴趣的吧推广-1<li>全屏广告-会员弹窗<li>局部广告-信息流广告<li>局部广告-感兴趣的吧推广-1-1-1-1|
|百度网盘|8|<li>全屏广告-活动弹窗<li>局部广告-各类局部广告<li>功能类-成长值页面签到<li>更新提示<li>权限提示-通知权限<li>评价提示<li>局部广告-悬浮广告<li>分段广告-暂不开启自动备份|
...
|哔哩哔哩|21|<li>开屏广告<li>局部广告-评论区顶部公告横幅<li>分段广告-动态推荐广告卡片<li>分段广告-视频卡片广告<li>局部广告-首页浮标广告<li>局部广告-视频页广告<li>局部广告-直播间悬浮窗广告<li>分段广告-搜索结果广告-1<li>功能类-自动关闭故事模式-1<li>功能类-自动点击评论区的[展开更多评论]-1<li>全屏广告-会员弹窗<li>全屏广告-分享稿件弹窗<li>分段广告-搜索结果广告-1-1-1-1<li>分段广告-视频详情页下方推广<li>功能类-自动关闭故事模式-1-1-1-1<li>功能类-自动点击评论区的[展开更多评论]-1-1-1-1<li>功能类-自动领取会员经验<li>功能类-自动点击查看原图<li>功能类-登录授权<li>功能类-直播自动点赞<li>功能类-直播自动投喂粉丝团|
...
|菜鸟|8|<li>全屏广告-弹窗广告<li>局部广告<li>更新提示<li>权限提示-通知权限<li>评价提示<li>功能类-询问[是否要查询包裹]弹窗<li>功能类-包裹页面-自动展开更多物流信息<li>其他-好友代取功能提示|
|餐大大|1|<li>开屏广告|
|畅听FM|1|<li>全屏广告-弹窗广告|
...
|大学搜题酱|10|<li>开屏广告<li>通知提示-请求推送通知弹窗<li>全屏广告<li>局部广告-卡片广告<li>更新提示<li>权限提示-通知权限<li>评价提示-请求好评弹窗<li>分段广告-信息流广告<li>全屏广告-邀好友得开学好礼<li>分段广告-底部卡片广告|
...
|饿了么|11|<li>更新提示<li>全屏广告-红包弹窗<li>全屏广告-活动弹窗<li>全屏广告-付款后弹窗广告<li>全屏广告-吃货卡续费弹窗<li>局部广告-首页底部浮窗广告<li>权限提示-定位权限<li>通知提示-获取订单信息通知<li>评价提示-底部调研邀请卡片-1<li>评价提示-底部调研邀请卡片-1-1-1-1<li>全屏广告-券包限量抢弹窗|
|鄂汇办|1|<li>开屏广告|
|儿歌多多|1|<li>局部广告-卡片广告|
|二柄|2|<li>开屏广告<li>分段广告|
|发现精彩|1|<li>全屏广告|
|番茄免费小说|15|<li>开屏广告<li>局部广告-阅读页面广告<li>更新提示<li>局部广告-首页右侧悬浮广告<li>全屏广告<li>全屏广告-阅读页面关注作者弹窗<li>分段广告-阅读页面广告<li>评价提示-请求好评弹窗<li>权限提示-通知权限<li>全屏广告-阅读翻页时的全屏广告<li>功能类-书城-底部继续阅读浮窗<li>功能类-阅读页面广告-点击下一页<li>功能类-观看广告自动领取奖励<li>评价提示-点评此书弹窗<li>全屏广告-会员福利弹窗|
...
|负一屏|1|<li>分段广告-卡片广告|
|富民银行|1|<li>开屏广告|
|高德地图|11|<li>开屏广告<li>更新提示<li>局部广告-首页签到卡片-1<li>功能类-截屏分享<li>通知提示-地图横条广告<li>局部广告-首页签到卡片-1-1-1-1<li>全屏广告-广告弹窗<li>局部广告-卡片广告<li>权限提示-授权蓝牙-1<li>功能类-一键点亮角落<li>权限提示-授权蓝牙-1-1-1-1|
|高佣联盟|1|<li>更新提示|
|稿定设计|1|<li>青少年模式-版本更新|
...
|航旅纵横|5|<li>全屏广告-1<li>功能类-首页-升级提示<li>功能类-进入飞行模式-提示弹窗<li>局部广告-首页广告<li>全屏广告-1-1-1-1|
...
|虎扑|1|<li>分段广告-信息流广告|
|虎牙直播|4|<li>局部广告-直播间悬浮广告<li>更新提示<li>全屏广告-弹窗广告<li>通知提示-root提示|
|花瓣|1|<li>更新提示-版本更新弹窗|
...
|华为天气|3|<li>开屏广告<li>青少年模式-卡片式广告<li>分段广告-卡片广告|
|华为音乐|3|<li>开屏广告<li>全屏广告-VIP弹窗广告<li>局部广告-推荐卡片广告|
|华为音乐|10|<li>开屏广告<li>更新提示-广告反馈下拉窗<li>局部广告-播放界面直播浮窗<li>通知提示-播放（音乐、视频）页面广告<li>权限提示-评论区广告<li>局部广告-视频播放页广告反馈<li>全屏广告-播放器上滑广告<li>全屏广告-弹窗广告<li>局部广告-卡片广告<li>分段广告-首页横幅广告|
|华为应用市场|8|<li>开屏广告<li>更新提示<li>功能类-应用更新页面-点击[查看更多]-1<li>功能类-应用更新页面-点击[查看更多]-1-1-1-1<li>全屏广告-热门应用推荐弹窗<li>局部广告-卡片广告<li>权限提示-通知权限<li>功能类-自动安装应用|
|华为阅读|1|<li>开屏广告|
|华为运动健康|7|<li>开屏广告<li>局部广告-“我的”页会员广告<li>全屏广告-弹窗广告<li>其他-个性化推荐弹窗<li>局部广告<li>其他-请求开启[实时推送步数]弹窗<li>更新提示|
|华为主题|9|<li>开屏广告<li>局部广告-悬浮广告<li>分段广告-卡片广告<li>局部广告-主题详情页广告关闭弹窗<li>局部广告-主题详情信息流广告<li>局部广告-分类页“免费领取”<li>局部广告-主页面（推荐、分类、我的）广告<li>全屏广告-首页活动弹窗<li>权限提示-通知权限|
|话本小说|2|<li>更新提示<li>功能类-阅读界面-底部社区问答|
|欢律|2|<li>更新提示<li>更新提示-耳机固件更新弹窗|
|汇率速查|1|<li>全屏广告|
|会计云课堂|1|<li>开屏广告|
|慧生活 798|3|<li>开屏广告<li>全屏广告<li>局部广告|
|极光下载器|1|<li>通知提示-系统公告|
|集换社|1|<li>开屏广告|
|加班|1|<li>全屏广告|
|驾考宝典|4|<li>开屏广告<li>局部广告-悬浮广告<li>全屏广告-弹窗广告<li>权限提示-通知权限|
|驾校一点通|2|<li>局部广告-卡片广告<li>全屏广告-弹窗广告|
|驾校一点通|3|<li>开屏广告<li>全屏广告<li>局部广告|
...
|交管12123|4|<li>开屏广告<li>通知提示-通知弹窗<li>通知提示-公告通知弹窗<li>更新提示|
...
|今日头条|12|<li>更新提示<li>局部广告-浮窗广告<li>功能类-[下次打开APP默认进入发现频道]弹窗-1<li>权限提示-通知权限<li>全屏广告-竖屏视频广告<li>分段广告-信息流广告<li>局部广告-底部话题推荐弹窗<li>功能类-自动观看广告视频<li>局部广告-底部热榜弹窗<li>全屏广告-广告弹窗<li>功能类-[下次打开APP默认进入发现频道]弹窗-1-1-1-1<li>全屏广告-弹窗广告|
|今日校园|1|<li>更新提示|
|金山文档|3|<li>局部广告-列表卡片广告<li>更新提示<li>权限提示-通知权限|
|金十数据|4|<li>更新提示<li>全屏广告-首页弹窗广告<li>全屏广告-快讯页面弹窗广告<li>局部广告-会员页面顶部广告|
|京东|13|<li>开屏广告<li>局部广告-购物车页面砸金蛋<li>局部广告-悬浮广告<li>通知提示<li>全屏广告-广告弹窗<li>局部广告-横幅广告<li>功能类-京东账号登录授权<li>局部广告-支付页面产品推荐<li>全屏广告-购物车页面支付成功弹窗广告<li>功能类-支付订单后点击[完成]<li>通知提示-关闭支付时各类开通弹窗<li>功能类-支付订单后跳过开通[刷脸支付]<li>功能类-展开全部订单信息|
...
|酷安|6|<li>开屏广告<li>分段广告-卡片广告<li>更新提示<li>权限提示-通知权限<li>功能类-自动查看原图<li>局部广告-应用推荐|
|酷狗概念版|10|<li>开屏广告<li>全屏广告-VIP弹窗-1<li>全屏广告-VIP弹窗-1-1-1-1<li>分段广告-我的页面-右侧悬浮反馈图标<li>更新提示<li>全屏广告-弹窗广告<li>功能类-播放页听歌领VIP<li>评价提示<li>分段广告-评论区广告<li>局部广告|
...
|快对|1|<li>青少年模式-首页广告弹窗|
|快看漫画|1|<li>局部广告-漫画界面底部弹窗广告|
|快科技|1|<li>开屏广告|
|快连 VPN|2|<li>通知提示-各种提示弹窗<li>功能类-免费会员弹窗|
|快码万能播放器|1|<li>全屏广告|
|快手|6|<li>全屏广告-首页红包弹窗<li>局部广告-首页左侧红包悬浮控件<li>功能类-推荐关注<li>评价提示<li>全屏广告-直播间广告<li>分段广告-信息流广告|
|快手极速版|7|<li>开屏广告<li>全屏广告-红包弹窗-1<li>全屏广告-朋友推荐弹窗<li>全屏广告-红包弹窗-1-1-1-1<li>局部广告-悬浮广告<li>分段广告-悬浮广告<li>评价提示|
|快牙|1|<li>局部广告-卡片广告|
|岚图汽车|1|<li>功能类-自动签到|
|蓝岛|1|<li>通知提示-通知弹窗|
|蓝豚豚|1|<li>开屏广告|
...
|美团外卖|4|<li>更新提示<li>更新提示-关闭美食广告弹窗<li>全屏广告-弹窗广告<li>局部广告-直播悬浮窗|
...
|米游社|7|<li>功能类-自动打卡<li>功能类-原神自动签到<li>功能类-星穹铁道自动签到<li>全屏广告-游戏版本活动<li>分段广告-游戏版本活动<li>功能类-米游自动签到全家桶<li>权限提示-通知权限|
...
|默往|1|<li>开屏广告|
|暮瑟|3|<li>分段广告-交友页面底部广告<li>通知提示-漂流瓶页面提示弹窗<li>权限提示-定位权限|
|南方航空|3|<li>功能类-长辈版弹窗-1<li>全屏广告-弹窗广告<li>功能类-长辈版弹窗-1-1-1-1|
...
|牛牛视频|1|<li>全屏广告-弹窗广告|
|欧乐影院|1|<li>开屏广告|
|胖乖生活|4|<li>开屏广告<li>更新提示<li>功能类-开启[自动抵扣]开关<li>全屏广告-弹窗广告|
|澎湃新闻|1|<li>全屏广告-弹窗广告|
|皮皮搞笑|2|<li>开屏广告<li>分段广告-信息流广告|
|皮皮喵|2|<li>开屏广告<li>全屏广告-弹窗广告|
|皮皮虾|10|<li>开屏广告<li>青少年模式<li>全屏广告-信息流广告<li>权限提示-通知权限<li>局部广告-右上角红包悬浮窗<li>更新提示<li>评价提示<li>全屏广告-集五福弹窗<li>局部广告-卡片广告<li>分段广告-信息流广告|
|拼多多|18|<li>更新提示<li>全屏广告-弹窗广告-1<li>全屏广告-弹窗广告-1-1-1-1<li>全屏广告-红包弹窗<li>全屏广告-多多买菜弹窗<li>局部广告-悬浮广告<li>全屏广告-多多视频每日签到弹窗<li>局部广告-商品详情页视频讲解窗口<li>功能类-多多视频每日自动签到<li>全屏广告-多多视频划到广告自动跳过<li>功能类-发送图片时自动勾选原图<li>全屏广告-下单后出现的弹窗<li>全屏广告-[个性化推荐]弹窗-1<li>青少年模式<li>权限提示-通知权限<li>全屏广告-[个性化推荐]弹窗-1-1-1-1<li>全屏广告-登录提现页面点击[跳过]<li>功能类-关闭截图后的弹窗|
|平安口袋银行|1|<li>全屏广告-首页-权益/抽奖弹窗|
|浦大喜奔|3|<li>通知提示-代理提示弹窗<li>全屏广告-首页弹窗广告<li>局部广告-悬浮广告|
|浦发银行|1|<li>通知提示-消息中心-系统通知请求|
|普益基金|1|<li>青少年模式-版本更新|
|七猫免费小说|8|<li>分段广告-阅读页面广告<li>全屏广告-阅读结束后显示的广告<li>全屏广告-签到弹窗<li>全屏广告-字节视频广告<li>局部广告-【百度】全屏广告<li>全屏广告-【腾讯】全屏广告<li>局部广告-卡片广告<li>全屏广告-今日专属推荐弹窗|
|七鲜|1|<li>全屏广告|
|奇妙应用|5|<li>局部广告-卡片广告<li>通知提示-公告弹窗<li>更新提示<li>局部广告-首页横幅广告<li>功能类-签到页-自动签到|
|企查查|1|<li>全屏广告-VIP弹窗|
...
|汽水音乐|9|<li>开屏广告<li>更新提示<li>全屏广告-VIP弹窗<li>功能类-看广告视频拿VIP<li>功能类-全自动看广告获取听歌时长<li>功能类-关闭广告的声音<li>评价提示-评分弹窗<li>局部广告-悬浮窗广告<li>其他-关闭[更多直播]推荐|
|前程无忧51Job|1|<li>全屏广告-弹窗广告|
|钱包|1|<li>全屏广告-弹窗广告|
|钱包|2|<li>开屏广告<li>全屏广告-弹窗广告|
|钱包|1|<li>权限提示-通知权限|
|亲宝宝|3|<li>全屏广告-弹窗广告<li>局部广告-横幅广告<li>更新提示|
|亲邻开门|6|<li>局部广告-首页顶部广告<li>全屏广告-弹窗广告<li>通知提示-开门成功提示<li>全屏广告-开门有奖弹窗<li>全屏广告-获得金币弹窗<li>全屏广告-开门成功后广告弹窗|
|青创网|1|<li>更新提示|
...
|什么值得买|4|<li>全屏广告-弹窗广告<li>更新提示<li>权限提示-通知权限<li>权限提示-请求读取剪贴板权限弹窗|
...
|书旗小说|4|<li>局部广告<li>全屏广告<li>更新提示-阅读页面底部广告<li>评价提示-听书页面底部广告|
|数独|1|<li>局部广告|
|数字人民币|1|<li>更新提示|
|水果派|1|<li>开屏广告|
|水果派|1|<li>开屏广告|
...
|通义千问|1|<li>开屏广告|
|同程旅行|3|<li>青少年模式-应用内卡片广告<li>全屏广告-弹窗广告<li>评价提示|
|同花顺|3|<li>开屏广告<li>分段广告-信息流广告<li>局部广告-底部产品广告|
|头条搜索极速版|7|<li>其他-首页-红包弹窗<li>其他-首页-右侧悬浮广告<li>其他-首页-你可能感兴趣的人<li>其他-任务页面-签到弹窗<li>其他-任务页面-右侧悬浮红包<li>其他-任务页面-答题弹窗<li>其他-搜索页面-搜索得金币弹窗|
|图凌|2|<li>开屏广告<li>全屏广告-会员回馈弹窗|
|图图影视|1|<li>全屏广告-弹窗广告|
|途虎养车|2|<li>全屏广告-弹窗广告<li>权限提示-通知权限|
|推栏|1|<li>开屏广告|
|挖财记账|3|<li>更新提示<li>全屏广告-弹窗广告<li>开屏广告|
|歪麦霸王餐|3|<li>开屏广告<li>全屏广告-弹窗广告<li>局部广告|
...
|万能遥控|3|<li>局部广告-底部横幅广告<li>权限提示-定位权限<li>局部广告|
...
|网易蜗牛读书|1|<li>开屏广告|
|网易新闻|4|<li>更新提示<li>权限提示-通知权限<li>评价提示-系统推送提示信息<li>分段广告-首页信息流广告|
|网易严选|1|<li>全屏广告-首页弹窗广告|
|网易邮箱|3|<li>开屏广告<li>局部广告-邮件列表页面广告条目<li>更新提示-切回时的开屏广告|
...
|稀饭动漫|1|<li>全屏广告-弹窗广告|
|稀土掘金|1|<li>更新提示|
|喜马拉雅|15|<li>局部广告-首页右侧浮动广告<li>局部广告-播放页广告<li>分段广告-播放页面-底部推荐列表-夹杂广告<li>全屏广告-播放页面-播放前广告<li>分段广告-信息流广告<li>局部广告-关闭热播推荐广告<li>更新提示<li>青少年模式<li>局部广告-评论区广告<li>分段广告-卡片式广告<li>全屏广告-首页-专辑订阅推荐弹窗<li>全屏广告-弹窗广告<li>权限提示-通知权限<li>全屏广告-免流提示<li>局部广告-有声书分类页面-信息流广告|
|喜马拉雅极速版|5|<li>开屏广告-首页-推荐-卡片广告<li>全屏广告-弹窗广告<li>全屏广告-小说推荐弹窗<li>全屏广告-支付宝提现弹窗广告<li>权限提示-通知权限|
...
|闲鱼|9|<li>通知提示<li>通知提示-开启个性化<li>更新提示<li>全屏广告<li>分段广告-信息流广告<li>功能类-自动查看原图<li>功能类-自动选中发送原图<li>功能类-登录授权<li>功能类-关闭小额免密支付|
...
|小包搜题|1|<li>局部广告-卡片广告|
|小步点|1|<li>全屏广告-弹窗广告|
|小蚕霸王餐|5|<li>开屏广告<li>全屏广告-弹窗广告<li>功能类-签到成功弹窗-1<li>全屏广告-优惠券弹窗<li>功能类-签到成功弹窗-1-1-1-1|
|小度|1|<li>开屏广告|
|小鹅通|1|<li>更新提示-版本更新弹窗|
|小恩爱|3|<li>开屏广告<li>全屏广告<li>局部广告-信息流广告|
|小飞机网盘|1|<li>分段广告|
|小黑盒|4|<li>功能类-签到成功弹窗<li>局部广告-卡片广告<li>功能类-自动点击查看原图<li>功能类-自动查看原图|
|小红帽|1|<li>全屏广告-弹窗广告|
...
|小米移动|1|<li>评价提示|
|小米音乐|11|<li>开屏广告<li>局部广告-悬浮广告<li>局部广告-横幅广告<li>全屏广告-弹窗广告<li>分段广告-首页卡片广告-1<li>全屏广告-弹窗广告（部分误触）<li>全屏广告-会员过期续费弹窗<li>局部广告-banner 广告<li>功能类-看广告视频领VIP<li>局部广告-主界面卡片广告<li>分段广告-首页卡片广告-1-1-1-1|
|小米应用商店|7|<li>全屏广告-首页悬浮窗广告<li>局部广告-应用升级界面顶部广告横幅<li>功能类-忽略升级<li>权限提示-通知权限<li>局部广告-个性化推荐卡片<li>功能类-自动点击[查看全部升级]<li>功能类-移动数据更新弹窗点击继续|
|小米游戏服务|1|<li>更新提示|
|小米游戏中心|1|<li>局部广告-首页右侧悬浮广告|
|小米有品|3|<li>全屏广告-弹窗广告<li>更新提示-版本升级弹窗<li>局部广告-主页贴片广告|
|小米云服务|3|<li>全屏广告-云存储空间不足弹窗<li>更新提示<li>权限提示-通知权限|
|小米运动健康|6|<li>评价提示<li>局部广告<li>全屏广告<li>更新提示<li>通知提示-公告栏<li>权限提示-麦克风|
...
|小猿口算|1|<li>评价提示|
|小猿搜题|3|<li>青少年模式-升级提示<li>评价提示<li>全屏广告-年卡广告|
|小周便签|1|<li>开屏广告|
...
|新大师兄影视|1|<li>全屏广告|
|新小财神影视|3|<li>通知提示-公告弹窗<li>全屏广告-弹窗广告<li>青少年模式-内部弹窗广告-2|
...
|学小易|2|<li>分段广告-首页信息流广告<li>更新提示|
|雪球|3|<li>局部广告-信息流广告<li>局部广告-评论区广告<li>全屏广告|
|雪球基金|1|<li>全屏广告-基金页面弹窗广告|
|迅雷|10|<li>开屏广告<li>分段广告<li>分段广告-视频详情-直播推荐<li>全屏广告<li>通知提示-【下载页】广告卡片<li>权限提示-搜索页面-顶部banner广告<li>更新提示<li>全屏广告-会员续费广告<li>局部广告-卡片广告<li>权限提示-通知权限|
...
|一个|1|<li>全屏广告|
|一刻相册|11|<li>开屏广告<li>更新提示-软件升级提醒<li>局部广告-悬浮窗广告<li>评价提示<li>全屏广告-会员弹窗<li>全屏广告-弹窗广告<li>权限提示-通知权限<li>局部广告-照片页底部浮窗广告<li>局部广告-卡片广告<li>权限提示-忽略电池优化<li>功能类-展示精选回忆故事|
...
|音乐|1|<li>局部广告-卡片广告|
|应用包管理组件|12|<li>功能类-放弃开启安全守护<li>功能类-安装来源不可信-1<li>功能类-自动第三方安装应用<li>功能类-自动安装应用<li>功能类-自动更新应用<li>功能类-澎湃-自动安装/更新<li>功能类-自动安装/更新应用<li>功能类-自动允许应用安装软件<li>功能类-安装来源不可信-1-1-1-1<li>功能类-备案信息弹窗<li>功能类-无视风险继续安装<li>功能类-自动勾选[已了解此应用存在风险]|
|应用宝|1|<li>功能类-关闭登录弹窗|
|应用汇|1|<li>全屏广告-弹窗广告|
|应用商店|3|<li>开屏广告<li>其他-[您是否年满 18 岁？]弹窗<li>全屏广告-[大家还下载了]弹窗|
|应用中心|1|<li>功能类-流量模式点击[继续下载]|
|萤石云视频|4|<li>开屏广告<li>分段广告-主页广告<li>功能类-在线值守试用弹窗<li>全屏广告-弹窗广告|
|影视|1|<li>更新提示|
|影视仓|1|<li>局部广告-卡片广告|
|影视大全|1|<li>局部广告-卡片广告|
|影视工场|1|<li>全屏广告-弹窗广告|
...
|优酷视频|5|<li>全屏广告-视频播放暂停时的广告<li>全屏广告-视频推荐弹窗<li>全屏广告-视频播放时的广告<li>局部广告-卡片广告<li>分段广告-首页卡片广告|
|优衣库|2|<li>全屏广告-弹窗广告<li>更新提示|
|悠洗|1|<li>全屏广告-弹窗广告|
|邮储银行|3|<li>局部广告-浮窗广告<li>全屏广告-首页广告弹窗<li>局部广告-首页-浮窗广告|
...
|云闪付|10|<li>分段广告-支付完成界面广告卡片<li>局部广告-浮窗广告<li>全屏广告-各类全屏弹窗广告<li>局部广告-右侧悬浮广告<li>权限提示-定位权限-1<li>权限提示-定位权限-1-1-1-1<li>权限提示-通知权限<li>全屏广告-天天签到-获得新勋章提示<li>其他-我的页面-广告弹窗<li>全屏广告-领取优惠弹窗|
|云视通|2|<li>局部广告-卡片广告<li>全屏广告-弹窗广告|
|云听|1|<li>全屏广告-首页弹窗广告|
|云蚁物联|3|<li>全屏广告<li>局部广告<li>权限提示-通知权限|
|云运动|1|<li>分段广告-首页卡片广告|
|运动世界|10|<li>全屏广告-弹窗广告<li>更新提示-百青藤广告<li>评价提示-快手广告<li>通知提示-百度广告<li>功能类-第三方SDK广告<li>局部广告-卡片广告<li>分段广告-卡片广告<li>通知提示-公告<li>权限提示-不开启可选权限<li>权限提示-定位权限|
|湛庐阅读|1|<li>更新提示|
|章鱼记账|1|<li>全屏广告|
...
|智联招聘|3|<li>局部广告-我的页面卡片广告<li>全屏广告-社区页面弹窗广告<li>通知提示-消息-开启消息通知|
|智能服务|3|<li>开屏广告<li>局部广告-miui-为什么不希望看到这条推广<li>分段广告-为什么不希望看到这条推广|
|智谱|3|<li>开屏广告<li>全屏广告-今日要闻弹窗<li>评价提示-首页-今日要闻-关闭|
|智校乐|1|<li>开屏广告|
|智行火车票|4|<li>开屏广告<li>更新提示-内测升级<li>功能类-添加桌面小组件<li>局部广告-代金券|
|中关村在线|1|<li>局部广告-首页悬浮广告|
|中国电信|9|<li>开屏广告<li>全屏广告-软件更新/安装后的用户引导<li>更新提示<li>全屏广告-浮窗广告<li>全屏广告-弹窗广告<li>权限提示-通知权限<li>功能类-右下角客服悬浮窗<li>局部广告-悬浮广告<li>功能类-英文版未登录时自动一键登录|
|中国工商银行|5|<li>开屏广告-第一次启动提示<li>全屏广告-弹窗广告<li>局部广告-右下角浮标广告-1<li>局部广告-右下角浮标广告-1-1-1-1<li>功能类-未登录时自动点击登录|
|中国广电|1|<li>更新提示|
|中国建设银行|3|<li>开屏广告<li>全屏广告-我的页面弹窗广告<li>通知提示-VPN风险弹窗|
|中国军号|3|<li>开屏广告<li>功能类-首页右侧浮窗<li>局部广告-右侧悬浮窗|
|中国联通|4|<li>权限提示<li>更新提示<li>全屏广告-弹窗广告<li>局部广告-首页右下角卡片悬浮窗|
|中国农业银行|5|<li>开屏广告-1<li>开屏广告-1-1-1-1<li>更新提示<li>权限提示-定位权限<li>权限提示-通知权限|
|中国人保|1|<li>更新提示|
...
|中国移动江苏|2|<li>青少年模式-版本更新<li>权限提示-通知权限|
...
|最右|5|<li>开屏广告<li>更新提示<li>分段广告-评论区卡片广告<li>权限提示-通知权限<li>其他-系统通知提示信息|
|最准天气|1|<li>局部广告-卡片广告|
|作业帮|1|<li>全屏广告-弹窗广告|
...
|biubiu加速器|2|<li>开屏广告<li>全屏广告-弹窗广告|
|Blued极速版|2|<li>青少年模式-附近的人-广告卡片<li>分段广告-卡片广告|
...
|miui主题壁纸|3|<li>分段广告-信息流广告<li>全屏广告-广告弹窗<li>局部广告-右下角悬浮窗广告|
|MT管理器|1|<li>更新提示|
|MT管理器Pro|1|<li>更新提示|
...
|PU口袋校园|6|<li>开屏广告<li>全屏广告-弹窗广告<li>局部广告-首页-右侧浮窗广告<li>更新提示<li>权限提示-通知权限<li>功能类-打开应用自动进入部落|
|QQ极速版|1|<li>更新提示|
|QQ浏览器|3|<li>开屏广告<li>分段广告-小说阅读页面-卡片广告<li>分段广告-小说阅读页面-视频广告|
|QQ音乐|11|<li>开屏广告<li>局部广告-卡片广告<li>全屏广告<li>全屏广告-看广告免费听歌弹窗<li>全屏广告-VIP弹窗<li>全屏广告-音质音效弹窗<li>分段广告-评论区广告-1<li>分段广告-评论区广告-1-1-1-1<li>评价提示-好评弹窗<li>分段广告-评论区广告-1-2-2-2<li>其他-播放页[猜你也会喜欢]推荐|
|QQ音乐车机版|1|<li>更新提示|
...
|tita搜索|2|<li>青少年模式-应用内第三方 SDK 广告<li>其他-观看视频去除广告提示弹窗|
|U净|1|<li>开屏广告|
