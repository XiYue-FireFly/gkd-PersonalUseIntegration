...
|YouTube|10|<li>全屏广告-视频播放-跳过广告<li>全屏广告-视频播放-赞助商广告<li>全屏广告-会员广告<li>局部广告<li>功能类-自动翻译评论<li>分段广告-播放页广告<li>其他-关闭播放器辅助功能弹窗<li>功能类-关闭视频播放结束后的推荐视频<li>局部广告<li>分段广告-播放页广告|
|阿里云盘|8|<li>功能类-自动签到<li>全屏广告-活动弹窗<li>功能类-时光设备间-自动点击<li>更新提示<li>通知提示-顶端横幅”<li>功能类-自动授权<li>全屏广告-[容量使用超限]提示<li>局部广告-卡片广告|
|安全服务/小米手机管家|10|<li>功能类-USB安装时自动继续安装<li>功能类-禁止获取定位<li>功能类-使用返回退出时直接点击[退出]<li>功能类-高敏感权限自动确定<li>功能类-高敏感权限自动确定<li>功能类-应用信息页-自启动提示<li>功能类-自动允许分享文件<li>功能类-自动关闭SIM卡安全保护验证提示<li>功能类-禁止后台运行弹窗<li>功能类-风险提示-仍然支付|
...
|百度贴吧|14|<li>开屏广告<li>通知提示-申请消息提醒弹窗<li>分段广告-信息流广告<li>局部广告-首页、推荐列表顶部卡片式广告<li>更新提示<li>未分类-帖子底部内容推荐卡片<li>全屏广告-广告弹窗<li>局部广告-悬浮小广告<li>局部广告-[帖子内/吧内]底部悬浮窗<li>功能类-贴吧内签到并关闭弹窗<li>局部广告-感兴趣的吧推广<li>全屏广告-会员弹窗<li>局部广告-信息流广告<li>局部广告-感兴趣的吧推广|
|百度网盘|8|<li>全屏广告-活动弹窗<li>局部广告-各类局部广告<li>功能类-成长值页面签到<li>更新提示<li>权限提示-通知权限<li>评价提示<li>局部广告-悬浮广告<li>分段广告-暂不开启自动备份|
|哔哩哔哩|21|<li>开屏广告<li>局部广告-评论区顶部公告横幅<li>分段广告-动态推荐广告卡片<li>分段广告-视频卡片广告<li>局部广告-首页浮标广告<li>局部广告-视频页广告<li>局部广告-直播间悬浮窗广告<li>分段广告-搜索结果广告<li>功能类-自动关闭故事模式<li>功能类-自动点击评论区的[展开更多评论]<li>全屏广告-会员弹窗<li>全屏广告-分享稿件弹窗<li>分段广告-搜索结果广告<li>分段广告-视频详情页下方推广<li>功能类-自动关闭故事模式<li>功能类-自动点击评论区的[展开更多评论]<li>功能类-自动领取会员经验<li>功能类-自动点击查看原图<li>功能类-登录授权<li>功能类-直播自动点赞<li>功能类-直播自动投喂粉丝团|
...
|斗鱼|1|<li>局部广告-直播间广告|
|饿了么|11|<li>更新提示<li>全屏广告-红包弹窗<li>全屏广告-活动弹窗<li>全屏广告-付款后弹窗广告<li>全屏广告-吃货卡续费弹窗<li>局部广告-首页底部浮窗广告<li>权限提示-定位权限<li>通知提示-获取订单信息通知<li>评价提示-底部调研邀请卡片<li>评价提示-底部调研邀请卡片<li>全屏广告-券包限量抢弹窗|
|高德地图|11|<li>开屏广告<li>更新提示<li>局部广告-首页签到卡片<li>功能类-截屏分享<li>通知提示-地图横条广告<li>局部广告-首页签到卡片<li>全屏广告-广告弹窗<li>局部广告-卡片广告<li>权限提示-授权蓝牙<li>功能类-一键点亮角落<li>权限提示-授权蓝牙|
|海南航空|1|<li>全屏广告-首页弹窗广告|
|航旅纵横|5|<li>全屏广告<li>未分类-首页-升级提示<li>功能类-进入飞行模式-提示弹窗<li>局部广告-首页广告<li>全屏广告|
...
|今日头条|12|<li>更新提示<li>局部广告-浮窗广告<li>功能类-[下次打开APP默认进入发现频道]弹窗<li>权限提示-通知权限<li>全屏广告-竖屏视频广告<li>分段广告-信息流广告<li>局部广告-底部话题推荐弹窗<li>功能类-自动观看广告视频<li>局部广告-底部热榜弹窗<li>全屏广告-广告弹窗<li>功能类-[下次打开APP默认进入发现频道]弹窗<li>全屏广告-弹窗广告|
...
|拼多多|18|<li>更新提示<li>全屏广告-弹窗广告<li>全屏广告-弹窗广告<li>全屏广告-红包弹窗<li>全屏广告-多多买菜弹窗<li>局部广告-悬浮广告<li>全屏广告-多多视频每日签到弹窗<li>局部广告-商品详情页视频讲解窗口<li>功能类-多多视频每日自动签到<li>全屏广告-多多视频划到广告自动跳过<li>功能类-发送图片时自动勾选原图<li>全屏广告-下单后出现的弹窗<li>全屏广告-[个性化推荐]弹窗<li>青少年模式<li>权限提示-通知权限<li>全屏广告-[个性化推荐]弹窗<li>全屏广告-登录提现页面点击[跳过]<li>功能类-关闭截图后的弹窗|
...
|小米音乐|11|<li>开屏广告<li>局部广告-悬浮广告<li>局部广告-横幅广告<li>全屏广告-弹窗广告<li>分段广告-首页卡片广告<li>全屏广告-弹窗广告（部分误触）<li>全屏广告-会员过期续费弹窗<li>局部广告-banner 广告<li>功能类-看广告视频领VIP<li>局部广告-主界面卡片广告<li>分段广告-首页卡片广告|
...
|应用包管理组件|12|<li>功能类-放弃开启安全守护<li>功能类-安装来源不可信<li>功能类-自动第三方安装应用<li>功能类-自动安装应用<li>功能类-自动更新应用<li>功能类-澎湃-自动安装/更新<li>功能类-自动安装/更新应用<li>功能类-自动允许应用安装软件<li>功能类-安装来源不可信<li>功能类-备案信息弹窗<li>功能类-无视风险继续安装<li>功能类-自动勾选[已了解此应用存在风险]|
|邮储银行|3|<li>局部广告-浮窗广告<li>全屏广告-首页广告弹窗<li>局部广告-首页-浮窗广告|
|云班课|1|<li>全屏广告-班课列表弹窗广告|
|云闪付|10|<li>分段广告-支付完成界面广告卡片<li>局部广告-浮窗广告<li>全屏广告-各类全屏弹窗广告<li>局部广告-右侧悬浮广告<li>权限提示-定位权限<li>权限提示-定位权限<li>权限提示-通知权限<li>全屏广告-天天签到-获得新勋章提示<li>未分类-我的页面-广告弹窗<li>全屏广告-领取优惠弹窗|
...
|知乎|13|<li>开屏广告<li>分段广告-信息流广告<li>权限提示-通知权限<li>全屏广告-广告弹窗<li>全屏广告-弹窗广告<li>局部广告-卡片广告<li>局部广告-回答底部广告<li>局部广告-悬浮广告<li>功能类-自动授权<li>功能类-自动展开回答<li>局部广告-评论区卡片广告<li>评价提示-评论区氛围评价卡片<li>功能类-自动展开回答|
|智联招聘|3|<li>局部广告-我的页面卡片广告<li>全屏广告-社区页面弹窗广告<li>未分类-消息-开启消息通知|
...
|中国工商银行|5|<li>未分类-第一次启动提示<li>全屏广告-弹窗广告<li>局部广告-右下角浮标广告<li>局部广告-右下角浮标广告<li>功能类-未登录时自动点击登录|
|中国广电|1|<li>更新提示|
|中国建设银行|3|<li>开屏广告<li>全屏广告-我的页面弹窗广告<li>通知提示-VPN风险弹窗|
|中国联通|4|<li>权限提示<li>更新提示<li>全屏广告-弹窗广告<li>局部广告-首页右下角卡片悬浮窗|
|中国农业银行|5|<li>开屏广告<li>开屏广告<li>更新提示<li>权限提示-定位权限<li>权限提示-通知权限|
...
|QQ音乐|11|<li>开屏广告<li>局部广告-卡片广告<li>全屏广告<li>全屏广告-看广告免费听歌弹窗<li>全屏广告-VIP弹窗<li>全屏广告-音质音效弹窗<li>分段广告-评论区广告<li>分段广告-评论区广告<li>评价提示-好评弹窗<li>分段广告-评论区广告<li>其他-播放页[猜你也会喜欢]推荐|
...
|爱奇艺|6|<li>开屏广告<li>未分类-青少年弹窗<li>局部广告-顶部卡片广告<li>权限提示-通知权限<li>更新提示<li>全屏广告-播放页-插入广告|
|爱奇艺极速版|1|<li>开屏广告|
|爱奇艺体育|1|<li>开屏广告|
|爱奇艺PAD|2|<li>开屏广告<li>全屏广告-暂停播放后出现的广告|
|爱企查|3|<li>更新提示<li>权限提示-通知权限<li>未分类-请求通知权限提示信息|
|爱山东|1|<li>开屏广告|
...
|豆瓣|10|<li>开屏广告<li>未分类-不分享/同步作品短评<li>未分类-剧照广告<li>分段广告-信息流广告<li>未分类-卡片广告<li>评价提示-关闭评分反馈弹窗<li>局部广告-卡片广告<li>全屏广告-弹窗广告<li>更新提示<li>其他-标记看过的影视弹窗|
|毒霸姬|1|<li>更新提示|
...
|华为天气|3|<li>开屏广告<li>未分类-卡片式广告<li>分段广告-卡片广告|
|华为音乐|3|<li>开屏广告<li>全屏广告-VIP弹窗广告<li>局部广告-推荐卡片广告|
|华为音乐|10|<li>开屏广告<li>未分类-广告反馈下拉窗<li>局部广告-播放界面直播浮窗<li>未分类-播放（音乐、视频）页面广告<li>未分类-评论区广告<li>未分类-视频播放页广告反馈<li>未分类-播放器上滑广告<li>全屏广告-弹窗广告<li>局部广告-卡片广告<li>分段广告-首页横幅广告|
|华为应用市场|8|<li>开屏广告<li>更新提示<li>功能类-应用更新页面-点击[查看更多]<li>功能类-应用更新页面-点击[查看更多]<li>全屏广告-热门应用推荐弹窗<li>局部广告-卡片广告<li>权限提示-通知权限<li>功能类-自动安装应用|
|华为阅读|1|<li>开屏广告|
...
|酷狗概念版|10|<li>开屏广告<li>全屏广告-VIP弹窗<li>全屏广告-VIP弹窗<li>分段广告-我的页面-右侧悬浮反馈图标<li>更新提示<li>全屏广告-弹窗广告<li>功能类-播放页听歌领VIP<li>评价提示<li>分段广告-评论区广告<li>局部广告|
...
|快手极速版|7|<li>开屏广告<li>全屏广告-红包弹窗<li>全屏广告-朋友推荐弹窗<li>全屏广告-红包弹窗<li>局部广告-悬浮广告<li>分段广告-悬浮广告<li>评价提示|
|快牙|1|<li>局部广告-卡片广告|
|岚图汽车|1|<li>功能类-自动签到|
|懒懒视频|1|<li>全屏广告-弹窗广告|
...
|美团外卖|4|<li>更新提示<li>未分类-关闭美食广告弹窗<li>全屏广告-弹窗广告<li>局部广告-直播悬浮窗|
...
|南方航空|3|<li>功能类-长辈版弹窗<li>全屏广告-弹窗广告<li>功能类-长辈版弹窗|
...
|皮皮虾|10|<li>开屏广告<li>青少年模式<li>综合广告-信息流广告<li>权限提示-通知权限<li>局部广告-右上角红包悬浮窗<li>更新提示<li>评价提示<li>全屏广告-集五福弹窗<li>局部广告-卡片广告<li>分段广告-信息流广告|
|浦大喜奔|3|<li>通知提示-代理提示弹窗<li>全屏广告-首页弹窗广告<li>局部广告-悬浮广告|
|七猫免费小说|8|<li>分段广告-阅读页面广告<li>全屏广告-阅读结束后显示的广告<li>全屏广告-签到弹窗<li>全屏广告-字节视频广告<li>未分类-【百度】全屏广告<li>未分类-【腾讯】全屏广告<li>局部广告-卡片广告<li>全屏广告-今日专属推荐弹窗|
|七鲜|1|<li>全屏广告|
...
|书旗小说|4|<li>局部广告<li>全屏广告<li>未分类-阅读页面底部广告<li>未分类-听书页面底部广告|
|数独|1|<li>局部广告|
|数字人民币|1|<li>更新提示|
|水果派|1|<li>开屏广告|
|水果派|1|<li>开屏广告|
...
|同程旅行|3|<li>未分类-应用内卡片广告<li>全屏广告-弹窗广告<li>评价提示|
...
|网易新闻|4|<li>更新提示<li>权限提示-通知权限<li>未分类-系统推送提示信息<li>分段广告-首页信息流广告|
|网易严选|1|<li>全屏广告-首页弹窗广告|
|网易邮箱|3|<li>开屏广告<li>局部广告-邮件列表页面广告条目<li>未分类-切回时的开屏广告|
...
|喜马拉雅极速版|5|<li>未分类-首页-推荐-卡片广告<li>全屏广告-弹窗广告<li>全屏广告-小说推荐弹窗<li>全屏广告-支付宝提现弹窗广告<li>权限提示-通知权限|
...
|小包搜题|1|<li>局部广告-卡片广告|
|小步点|1|<li>全屏广告-弹窗广告|
|小蚕霸王餐|5|<li>开屏广告<li>全屏广告-弹窗广告<li>功能类-签到成功弹窗<li>全屏广告-优惠券弹窗<li>功能类-签到成功弹窗|
...
|小猿口算|1|<li>评价提示|
|小猿搜题|3|<li>未分类-升级提示<li>评价提示<li>全屏广告-年卡广告|
|小周便签|1|<li>开屏广告|
...
|新大师兄影视|1|<li>全屏广告|
|新小财神影视|3|<li>通知提示-公告弹窗<li>全屏广告-弹窗广告<li>未分类-内部弹窗广告-2|
...
|迅雷|10|<li>开屏广告<li>分段广告<li>分段广告-视频详情-直播推荐<li>全屏广告<li>未分类-【下载页】广告卡片<li>未分类-搜索页面-顶部banner广告<li>更新提示<li>全屏广告-会员续费广告<li>局部广告-卡片广告<li>权限提示-通知权限|
...
|优酷视频|5|<li>综合广告-视频播放暂停时的广告<li>全屏广告-视频推荐弹窗<li>全屏广告-视频播放时的广告<li>局部广告-卡片广告<li>分段广告-首页卡片广告|
...
|运动世界|10|<li>全屏广告-弹窗广告<li>未分类-百青藤广告<li>未分类-快手广告<li>未分类-百度广告<li>未分类-第三方SDK广告<li>局部广告-卡片广告<li>分段广告-卡片广告<li>通知提示-公告<li>权限提示-不开启可选权限<li>权限提示-定位权限|
|湛庐阅读|1|<li>更新提示|
|章鱼记账|1|<li>全屏广告|
...
|招商银行|4|<li>局部广告-首页活动悬浮广告<li>局部广告-首页活动悬浮广告<li>全屏广告-弹窗广告<li>权限提示-定位权限|
...
|智谱|3|<li>开屏广告<li>全屏广告-今日要闻弹窗<li>未分类-首页-今日要闻-关闭|
|智校乐|1|<li>开屏广告|
...
|中国移动江苏|2|<li>未分类-版本更新<li>权限提示-通知权限|
...
|最右|5|<li>开屏广告<li>更新提示<li>分段广告-评论区卡片广告<li>权限提示-通知权限<li>未分类-系统通知提示信息|
|最准天气|1|<li>局部广告-卡片广告|
|作业帮|1|<li>全屏广告-弹窗广告|
...
|Blued极速版|2|<li>未分类-附近的人-广告卡片<li>分段广告-卡片广告|
