  ...
  groups: [
{
      ...
      rules: [
      {
        ...
        snapshotUrls: ['https://i.gkd.li/i/12901417', 'https://i.gkd.li/i/12908742'],
        action: 'clickCenter',
        _uniqueKey: 0
      },
      {
        ...
        matches: '[text^="跳过"][text.length<=10]',
        snapshotUrls: ['https://i.gkd.li/i/12901417', 'https://i.gkd.li/i/12908742'],
        exampleUrls: ['https://github.com/gkd-kit/inspect/assets/38517192/6c34cd13-cfda-4462-99ed-2a2534a6fdf5', 'https://github.com/gkd-kit/inspect/assets/38517192/c71bb14d-cd1f-4f9e-8ee9-6a1e11e56901'],
        action: 'clickCenter',
        _uniqueKey: 1
      },
      ],
    },
{
      ...
      {
        key: 0,
        matches: '[id="com.android.mediacenter:id/iv_close"]',
        _uniqueKey: 0
      },
      ],
    },
