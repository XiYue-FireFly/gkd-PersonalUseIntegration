  ...
  groups: [
{
      ...
      rules: [
      {
        ...
        matches: ['[text="广告"]', '[id="com.cctv.cctv5ultimate:id/iv_close"]'],
    ...
    },
{
      ...
      {
        key: 0,
        activityIds: 'com.cctv.cctv5ultimate.videodetail.activity.VideoDetailActivity',
        matches: '@ImageView[clickable=true][childCount=0] + LinearLayout > [text="广告"]',
