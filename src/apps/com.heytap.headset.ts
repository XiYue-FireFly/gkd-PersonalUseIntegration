  ...
  groups: [
{
      ...
      rules: [
      {
        ...
        matches: ['[text="发现新版本"][visibleToUser=true]', '[text="取消"][visibleToUser=true]'],
        snapshotUrls: ['https://i.gkd.li/i/14971296', 'https://i.gkd.li/i/20601909'],
        _uniqueKey: 0
      },
      ],
    },
{
      ...
      rules: [
      {
        ...
        matches: ['[text="耳机固件更新"][visibleToUser=true]', '[text="取消"][visibleToUser=true]'],
