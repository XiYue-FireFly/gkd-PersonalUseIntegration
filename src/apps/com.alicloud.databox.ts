  ...
  },
{
    ...
    rules: [
      ...
      { key: 0, matches: '[text^="好运盲盒"] >n View > Image + TextView[clickable=true]' },
    ],
  },
{
    key: 2,
    ...
    rules: [
      { key: 0, matches: 'View[childCount=9] > @Image -2 View[childCount=5]' },
    ],
  },
{
    key: 3,
    ...
    rules: [
      {
          ...
          matches: [
              '[id="com.alicloud.databox:id/ivTitleAction"]',
          ],
      ...
      },
      {
          ...
          name: '备份盘、资源库',
          matches: [
              '[id="com.alicloud.databox:id/notice_view_icon_button"]',
          ],
          snapshotUrls: [
      ...
      { key: 0, matches: '[vid="layoutLuckyBottle"] >3 [vid="ivClose"]' },
    ],
  },
{
    key: 5,
