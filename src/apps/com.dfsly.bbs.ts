  ...
  groups: [
{
      ...
      {
        key: 0,
        matches: '[id="android:id/content"] >7 FrameLayout[childCount=7] > LinearLayout >3 ImageView[text=null][visibleToUser=true]',
    ...
    },
{
      ...
      rules: [
      {
        ...
        snapshotUrls: ['https://i.gkd.li/i/13335135', 'https://i.gkd.li/i/13335316'],
        fastQuery: true,
        _uniqueKey: 0
      },
      {
      ...
      {
        key: 2,
        matches: ['[id="android:id/content"] >n FrameLayout[childCount=5 || childCount=8] > FrameLayout > ImageView[text=null][visibleToUser=true]'],
        snapshotUrls: ['https://i.gkd.li/i/13343675', 'https://i.gkd.li/i/13335135', 'https://i.gkd.li/i/13335316'],
        _uniqueKey: 2
      },
      ],
    },
