    ...
    },
{
      ...
      {
        key: 1,
        matches: '@FrameLayout[clickable=true] - * >2 [desc="立即升级"]',
        _uniqueKey: 1
      },
      ],
    },
{
      ...
      {
        key: 0,
        activityIds: ['com.eastmoney.android.fund.centralis.activity.FundRootActivity', 'com.eastmoney.android.fund.activity.FundSplashActivity'],
        ...
        snapshotUrls: ['https://i.gkd.li/i/14149452', 'https://i.gkd.li/i/14332091'],
