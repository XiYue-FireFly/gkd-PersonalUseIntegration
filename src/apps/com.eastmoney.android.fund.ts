  ...
  groups: [
{
    ...
    rules: [
      ...
      { key: 0, matches: 'FrameLayout > FrameLayout > ImageView + FrameLayout[childCount=1] > ImageView' },
    ],
  },
{
    key: 2,
    ...
    rules: [
      ...
      { key: 0, matches: '[desc="表示场内基金的最新价和折价率"] -(2) FrameLayout < FrameLayout + ImageView' },
    ],
  },
{
    key: 3,
    ...
    rules: [
      ...
      { key: 0, matches: '@FrameLayout[clickable=true] - * >2 [desc="立即升级"]' },
    ],
  },
{
    key: 4,
    ...
    rules: [
      ...
      { key: 0, matches: '[desc="五星好评"] - [desc="下次再说"]' },
    ],
  },
{
    key: 5,
