  ...
  groups: [
{
      ...
      rules: [
      {
        ...
        snapshotUrls: ['https://i.gkd.li/i/14050836', 'https://i.gkd.li/i/14235476', 'https://i.gkd.li/i/14235479'],
        _uniqueKey: 0
      },
      {
        key: 1,
      ...
      },
      {
        key: 2,
        activityIds: 'com.xifeng.fun.MainActivity',
        matches: '[id="android:id/content"] >2 FrameLayout[childCount>2] >(1,2) FrameLayout[childCount>4] >2 ImageView',
        snapshotUrls: ['https://i.gkd.li/i/14050836', 'https://i.gkd.li/i/14235476', 'https://i.gkd.li/i/14235478', 'https://i.gkd.li/i/14235479'],
        _uniqueKey: 2
      },
      ],
    },
{
      ...
      rules: [
      {
        ...
        exampleUrls: 'https://m.gkd.li/57941037/971c3631-a9cc-4aec-992e-6cf1166eea1b',
        _uniqueKey: 0
      },
      ],
    },
