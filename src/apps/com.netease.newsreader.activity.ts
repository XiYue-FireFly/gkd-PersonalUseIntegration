  ...
  groups: [
{
    ...
    rules: [
      { key: 0, matches: '[text$="版本更新了"] +(2) RelativeLayout > [text="稍后再说"]' },
    ],
  },
{
    key: 2,
    ...
    rules: [
      ...
      { key: 0, matches: '[text*="开启系统推送"] - ImageView < * < * < FrameLayout + FrameLayout >(3) Button[text="暂不开启"]' },
    ],
  },
{
    key: 3,
    ...
    snapshotUrls: 'https://i.gkd.li/i/12639869',
    rules: [
      { key: 0, matches: '[text^="打开推送"] +(2) RelativeLayout > ImageView' },
    ],
  },
{
    key: 4,
