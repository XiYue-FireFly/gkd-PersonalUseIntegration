  ...
  },
{
    ...
    rules: [
      ...
      { key: 0, matches: '[id="com.ecitic.bank.mobile:id/id_cordova_view"] + [id="com.ecitic.bank.mobile:id/close_product_send"]' },
    ],
  },
{
    key: 3,
    ...
    rules: [
      ...
      { key: 0, matches: '@[text="取消"] + [text="立即开启"]' },
    ],
  },
{
    key: 4,
    ...
    rules: [
      ...
      { key: 0, matches: '@[clickable=true] +2 [text="恭喜您关注到宝藏基金"]' },
    ],
  }
  ],
});
