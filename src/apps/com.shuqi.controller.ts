  ...
  groups: [
{
      ...
      rules: [
      {
        ...
        snapshotUrls: ['https://i.gkd.li/i/23831955', 'https://i.gkd.li/i/24859977'],
        exampleUrls: 'https://e.gkd.li/a634cd5a-7b84-44ad-b65b-99f5e8769eeb',
        fastQuery: true,
        anyMatches: ['[vid="promotion_close"][visibleToUser=true]', '[visibleToUser=true][vid="promotion_close"]'],
        _uniqueKey: 0
      },
      {
        key: 1,
    ...
    },
{
      ...
      },
      {
        ...
        matches: ['[text*="优惠券"]', '[id="com.shuqi.controller:id/close_btn"]'],
