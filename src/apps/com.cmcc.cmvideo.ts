  ...
  groups: [
{
    ...
    rules: [
      { key: 0, matches: '[id="com.cmcc.cmvideo:id/iv_right_bottom_close"]' },
    ],
  },
{
    key: 3,
    ...
    rules: [
      ...
      { key: 0, matches: '[id="com.cmcc.cmvideo:id/btn_update_close"]' },
    ],
  },
{
    key: 4,
    ...
    rules: [
      ...
      { key: 0, matches: '[id="com.cmcc.cmvideo:id/base_dialog_left_btn"][text="以后再说"]' },
    ],
  },
{
    key: 5,
