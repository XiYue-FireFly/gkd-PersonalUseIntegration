  ...
  groups: [
{
    ...
    rules: [
      { key: 0, matches: '@[desc="关闭"] + [text$="现金红包"]' },
    ],
  },
{
    key: 11,
    ...
    rules: [
      { key: 0, matches: 'FrameLayout[id!=null] > @ImageView[id!=null][clickable=true] + ImageView[id!=null]' },
    ],
  },
{
    key: 12,
    name: '未分类-首页-你可能感兴趣的人',
    enable: false,
    activityIds: 'com.ss.android.article.lite.activity.SplashActivity',
    snapshotUrls: 'https://i.gkd.li/i/12705427',
    rules: [
      { key: 0, matches: '[text="你可能感兴趣的人"] + [desc="关闭"]' },
    ],
  },
{
    key: 20,
...
{
    key: 21,
    name: '未分类-任务页面-右侧悬浮红包',
    enable: false,
    activityIds: 'com.ss.android.article.lite.activity.SplashActivity',
    snapshotUrls: 'https://i.gkd.li/i/12705447',
    rules: [
      { key: 0, matches: 'UIScrollView + UIView + UISvg' },
    ],
  },
{
    key: 22,
