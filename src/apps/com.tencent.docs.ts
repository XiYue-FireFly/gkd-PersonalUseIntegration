  ...
  groups: [
{
    ...
    rules: [
      ...
      { key: 0, matches: '@LinearLayout > [id="com.tencent.docs:id/tv_gdt_ad_text"]' },
    ],
  },
{
    key: 1,
    ...
    rules: [
      ...
      { key: 0, matches: '@[desc="暂不更新"] + [desc="现在更新"]' },
    ],
  },
{
    key: 2,
    ...
    rules: [
      ...
      { key: 0, matches: '[desc="限时购买"] + ImageView[clickable=true]' },
    ],
  },
{
    key: 3,
    ...
    rules: [
      ...
      { key: 0, matches: 'View[childCount=2] > @TextView[id=null][clickable=true] + View' },
    ],
  }
  ],
});
