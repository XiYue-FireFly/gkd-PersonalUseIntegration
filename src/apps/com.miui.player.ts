  ...
  },
{
    ...
    rules: [
      ...
      { key: 0, matches: '[id="com.miui.player:id/free_mode_tips_layout"] + [id="com.miui.player:id/iv_close"]' },
    ],
  },
{
    key: 2,
  ...
  },
{
    ...
    rules: [
      ...
      { key: 0, matches: 'ViewGroup > @ViewGroup + ViewGroup[childCount=5]' },
    ],
  },
{
    key: 4,
    ...
    rules: [
      ...
      { key: 0, matches: '[id="com.miui.player:id/cl_floating_promote"] > [id="com.miui.player:id/iv_close"]' },
    ],
  },
{
    key: 5,
    ...
    rules: [
      ...
      { key: 0, matches: '[id="com.miui.player:id/iv_close_dialog_button"]' },
    ],
  },
{
    key: 10,
    ...
    rules: [
      { key: 0, matches: '[id=null][desc="关闭弹框按钮"][clickable=true]' },
    ],
  },
{
    key: 11,
    ...
    rules: [
      ...
      { key: 0, matches: '[id="com.miui.player:id/banner_image"] + [id="com.miui.player:id/close_banner"]' },
    ],
  },
{
    key: 12,
