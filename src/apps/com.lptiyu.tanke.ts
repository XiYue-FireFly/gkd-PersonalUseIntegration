  ...
  groups: [
{
      ...
      rules: [
      {
        ...
        matches: '[id="com.lptiyu.tanke:id/interact_ad_root"] >n [id="com.lptiyu.tanke:id/iv_close"]',
        snapshotUrls: ['https://i.gkd.li/i/12829816', 'https://i.gkd.li/i/12869344', 'https://i.gkd.li/i/13378925'],
        _uniqueKey: 0
      },
      {
        key: 1,
      ...
      },
      {
        key: 2,
        name: '快手广告-1',
        activityIds: ['com.lptiyu.tanke.activities.splash.SplashActivity', 'com.lptiyu.tanke.activities.school_run_record_detail.RunRecordDetailActivity'],
        ...
        snapshotUrls: ['https://i.gkd.li/i/13218232', 'https://i.gkd.li/i/13536714'],
        fastQuery: true,
        _uniqueKey: 2
      },
      {
        ...
        matches: '[text="广告"] <2 ViewGroup - ViewGroup > ViewGroup > [text="跳过"]',
      ...
      },
      {
        ...
        name: '快手广告-3',
        activityIds: 'com.lptiyu.tanke.activities.splash.SplashActivity',
        matches: '[id="com.lptiyu.tanke:id/ksad_splash_circle_skip_left_view"]',
      ...
      },
      {
        ...
        name: '其他广告',
        activityIds: 'com.lptiyu.tanke.activities.splash.SplashActivity',
        matches: '@LinearLayout > [id="com.lptiyu.tanke:id/skip_parent_view"]',
        snapshotUrls: 'https://i.gkd.li/i/13166361',
        _uniqueKey: 5
      },
      {
        key: 6,
        activityIds: ['.activities.school_run_record_detail.RunRecordDetailActivity', '.activities.main.MainActivity'],
        matches: '[vid="ad_close"][visibleToUser=true]',
        snapshotUrls: ['https://i.gkd.li/i/22863742', 'https://i.gkd.li/i/23549297'],
      ...
      },
      {
        ...
        name: '快手广告-1-1',
        activityIds: ['com.lptiyu.tanke.activities.splash.SplashActivity', 'com.lptiyu.tanke.activities.school_run_record_detail.RunRecordDetailActivity'],
        matches: '[text="广告"] <2 ViewGroup -n ViewGroup > @ViewGroup[childCount=1] > ImageView',
        snapshotUrls: ['https://i.gkd.li/i/13218232', 'https://i.gkd.li/i/13536714'],
        _uniqueKey: 8,
