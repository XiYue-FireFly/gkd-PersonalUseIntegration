  ...
  groups: [
{
    ...
    rules: [
      ...
      { key: 0, matches: '[text="飞书 桌面端登录确认"] +2 [id="com.ss.android.lark:id/login_button"]' },
    ],
  },
{
    key: 10,
    ...
    rules: [
      ...
      { key: 0, matches: '[id="com.ss.android.lark:id/look_origin_icon"]' },
    ],
  },
{
    key: 11,
    ...
    rules: [
      ...
      { key: 0, matches: '@View[id$="original_photo"][checked=false] + [id="com.ss.android.lark:id/original_label"][text="原图"]' },
    ],
  }
  ],
});
