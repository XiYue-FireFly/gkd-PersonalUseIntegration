  ...
  groups: [
{
    ...
    rules: [
      ...
      { key: 0, matches: '[text="对当前的评论区满意吗？"] + [id="com.bilibili.app.in:id/close"]' },
    ],
  },
{
    key: 6,
    ...
    rules: [
      ...
      { key: 0, matches: '[id="com.bilibili.app.in:id/cancel"][text="下次再说"]' },
    ],
  },
{
    key: 7,
    ...
    rules: [
      ...
      { key: 0, matches: '[text="订阅感兴趣的通知"] +2 LinearLayout [text="暂不开启"]' },
    ],
  },
{
    key: 8,
    ...
    rules: [
      ...
      { key: 0, matches: '[text="打开推送通知"] +2 LinearLayout > [id="com.bilibili.app.in:id/close"]' },
    ],
  },
{
    key: 9,
    name: '功能类-自动领取会员经验',
    snapshotUrls: [
      'https://i.gkd.li/i/22886723',
      'https://i.gkd.li/i/22886739',
    ],
    rules: [
      {
          fastQuery: true,
