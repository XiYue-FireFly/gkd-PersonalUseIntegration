  ...
  },
{
    ...
    rules: [
      ...
      { key: 0, matches: '[id="com.baidu.youavideo:id/dialog_open_guide_notification_root"] > [id="com.baidu.youavideo:id/img_close"]' },
    ],
  },
{
    key: 8,
    ...
    rules: [
      ...
      { key: 0, matches: '[id="com.baidu.youavideo:id/cl_root"] + [id="com.baidu.youavideo:id/img_close"]' },
    ],
  },
{
    key: 9,
    ...
    rules: [
      {
          ...
          snapshotUrls: [
              ...
              'https://i.gkd.li/i/15220559',
          ],
      },
      { key: 0, matches: '[vid="riv_banner"] < * > [vid="iv_close"][visibleToUser=true]' },
    ],
  },
{
    key: 10,
    ...
    rules: [
      { key: 0, matches: '[text*="电池优化权限"] < * +n [vid="bottom_two_button_layout"] >n [vid="cancel"]' },
    ],
  },
{
    key: 12,
    ...
    rules: [
      { key: 0, matches: '[text="在桌面展示精选回忆故事"] - [vid="iv_close"]' },
    ],
  }
  ],
});
