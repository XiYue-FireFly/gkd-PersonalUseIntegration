  ...
  groups: [
{
    ...
    fastQuery: true,
    rules: [
      { key: 0, matches: '[id="com.ximalaya.ting.lite:id/main_ad_top_home_iv_close"]' },
    ],
  },
{
    key: 1,
    ...
    rules: [
      {
          ...
          matches: '@Image < View + View + View > View > View > TextView[text="广告"]',
  ...
  },
{
    ...
    rules: [
      ...
      { key: 0, matches: '[id="com.ximalaya.ting.lite:id/main_iv_novel_back"]' },
    ],
  },
{
    key: 3,
    ...
    rules: [
      ...
      { key: 0, matches: '[id="com.ximalaya.ting.lite:id/main_login_guide_close"]' },
    ],
  },
{
    key: 4,
    ...
    rules: [
      {
          ...
          matches: '[text="立即开启"] + [id="com.ximalaya.ting.lite:id/host_dialog_cancel_iv"]',
          snapshotUrls: 'https://i.gkd.li/i/13256505',
      },
      { key: 0, matches: '[text="立即开启"] + [id="com.ximalaya.ting.lite:id/host_dialog_cancel_iv"]' },
    ],
  }
  ],
});
