  ...
  groups: [
{
      ...
      rules: [
      {
        ...
        snapshotUrls: ['https://i.gkd.li/i/12657379', 'https://i.gkd.li/i/13069736', 'https://i.gkd.li/i/13762181'],
        action: 'clickCenter',
        _uniqueKey: 0
      },
      {
    ...
    },
{
      ...
      rules: [
      {
        ...
        snapshotUrls: ['https://i.gkd.li/i/16992846', 'https://i.gkd.li/i/16993185'],
      ...
      {
        key: 3,
        activityIds: ['com.huawei.openalliance.ad.activity.FeedbackActivity', '.HwThemeManagerActivity'],
        snapshotUrls: ['https://i.gkd.li/i/16992845', 'https://i.gkd.li/i/16993186'],
        exampleUrls: ['https://e.gkd.li/93458efb-d891-46b3-a2a0-8629a0399731', 'https://e.gkd.li/0e72693d-4ad3-4efd-b469-5aa635dd958b'],
        preKeys: [0,1,2],
        anyMatches: ['[text="直接关闭"]', '@[clickable=true] >2 [text="不感兴趣"]'],
        _uniqueKey: 3
      },
      {
        key: 4,
        ...
        snapshotUrls: ['https://i.gkd.li/i/12647248', 'https://i.gkd.li/i/12647292', 'https://i.gkd.li/i/12647367'],
        _uniqueKey: 4
      },
      ],
    },
    ...
    },
{
      ...
      name: '局部广告-主题详情信息流广告',
      enable: false,
      activityIds: ['com.huawei.android.thememanager.mvp.view.activity.onlinetheme.OnlineThemePreviewActivity', 'com.huawei.android.thememanager.mvp.view.activity.onlinewallpaper.OnlineWallpaperPreviewActivity', 'com.huawei.android.thememanager.mvp.view.activity.onlinefont.OnlineFontPreviewActivity', 'com.huawei.android.thememanager.mvp.view.activity.paster.PasterDetailActivity', 'com.huawei.android.thememanager.mvp.view.activity.onlinetheme.LocalThemePreviewActivity'],
      rules: [
      {
        key: 0,
        matches: '[id="com.huawei.android.thememanager:id/pps_lable_top"||id="com.huawei.android.thememanager:id/pps_img_video_close"]',
        snapshotUrls: ['https://i.gkd.li/i/12647311', 'https://i.gkd.li/i/12647346'],
        _uniqueKey: 0
      },
      {
        key: 1,
    ...
    },
{
      ...
      rules: [
      {
        ...
        snapshotUrls: ['https://i.gkd.li/i/12647614', 'https://i.gkd.li/i/12647653', 'https://i.gkd.li/i/12647650', 'https://i.gkd.li/i/12657822'],
        _uniqueKey: 0
      },
      {
        key: 1,
    ...
    },
{
      ...
      {
        key: 0,
        activityIds: ['com.huawei.android.thememanager.HwThemeManagerActivity', 'com.huawei.android.launcher.unihome.UniHomeLauncher'],
        matches: '[id="com.huawei.android.thememanager:id/campaign_dialog_close_image"]',
        snapshotUrls: ['https://i.gkd.li/i/12657939', 'https://i.gkd.li/i/12667815'],
        _uniqueKey: 0
      },
      {
        key: 1,
