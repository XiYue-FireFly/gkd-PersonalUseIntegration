    ...
    rules: [
      {
          key: 0,
          name: '点击关闭',
          matches: 'View < @FrameLayout[desc^="dislike"] <<n [id="com.pleasure.trace_wechat:id/adsuyi_id_view_response"]',
      ...
      },
      {
          ...
          name: '关闭原因"不感兴趣"',
          matches: '@LinearLayout > [id="com.byted.pangle:id/tt_item_tv"][text="不感兴趣"]',
  ...
  },
{
    ...
    rules: [
      ...
      { key: 0, matches: '[text="反馈"] -2 @View > Image' },
    ],
  }
  ],
});
