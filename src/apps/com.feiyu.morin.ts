  ...
  groups: [
{
      ...
      },
      {
        key: 2,
        activityIds: 'com.feiyu.morin.view.main.MainActivity',
        matches: '@ViewGroup[clickable=true][childCount=1] < ViewGroup +2 ViewGroup > [text="广告"]',
      ...
      },
      {
        ...
        name: '快手广告-1',
        activityIds: 'com.feiyu.morin.view.main.MainActivity',
        matches: ['ViewGroup[childCount=2] > ImageView + [text="广告"]', '@ViewGroup > [text="跳过"]'],
        snapshotUrls: 'https://i.gkd.li/i/13546184',
        _uniqueKey: 5,
        _uniqueName: '快手广告-1',
        name: '快手广告-1'
    ...
    },
{
      ...
      rules: [
      {
        key: 0,
        name: '腾讯广告',
        activityIds: ['com.feiyu.morin.view.main.MainActivity', 'com.feiyu.morin.view.main.PlayerBottomControlActivity'],
        ...
        snapshotUrls: ['https://i.gkd.li/i/13521680', 'https://i.gkd.li/i/13625476'],
        fastQuery: true,
        _uniqueKey: 0
      },
      {
        ...
        name: '腾讯广告-1',
        activityIds: ['com.feiyu.morin.view.main.MainActivity', 'com.feiyu.morin.view.main.PlayerBottomControlActivity'],
        matches: 'ImageView + LinearLayout + LinearLayout + FrameLayout[childCount=1] > ImageView[childCount=0]',
        snapshotUrls: ['https://i.gkd.li/i/13521680', 'https://i.gkd.li/i/13625476'],
        _uniqueKey: 1,
        _uniqueName: '腾讯广告-1',
        name: '腾讯广告-1'
