  ...
  groups: [
{
      ...
      rules: [
      {
        ...
        snapshotUrls: ['https://i.gkd.li/i/16451775', 'https://i.gkd.li/i/18668837'],
        exampleUrls: 'https://e.gkd.li/03b70de9-9e1d-4362-83df-08a95c2c224f',
        _uniqueKey: 0
      },
      {
        key: 1,
        matches: 'ImageView[desc="skip_button"] + ViewGroup > TextView[text="跳过"]',
      ...
      {
        key: 4,
        snapshotUrls: ['https://i.gkd.li/i/23096608', 'https://i.gkd.li/i/24695040'],
        exampleUrls: 'https://e.gkd.li/bff8f543-e262-4db1-b99b-32e2988fb47b',
        anyMatches: ['[text*="跳过"][text.length<10][clickable=true][visibleToUser=true]', '@[clickable=true] > [text*="跳过"][text.length<10][visibleToUser=true]'],
        _uniqueKey: 4
      },
      ],
    },
{
      ...
      rules: [
      {
        ...
        snapshotUrls: ['https://i.gkd.li/i/16869245', 'https://i.gkd.li/i/24694978'],
