  ...
  groups: [
{
    ...
    rules: [
      ...
      { key: 0, matches: '[vid="splash_adv_ship"]' },
    ],
  },
{
    key: 1,
    ...
    rules: [
      { key: 0, matches: '[vid="fragment_containerx"] > FrameLayout > ImageView[index=2][clickable=true]' },
    ],
  },
{
    key: 2,
    ...
    rules: [
      ...
      { key: 0, matches: '[vid="float_feedback"] > ImageView[index=2][clickable=true]' },
    ],
  }
  ],
});
