  ...
  groups: [
{
      ...
      {
        key: 1,
        matches: ['ImageView + [id=null][text="广告"]', 'ImageView + [id=null][text="跳过"]'],
      ...
      },
      {
        ...
        snapshotUrls: ['https://i.gkd.li/i/12700837', 'https://i.gkd.li/i/12700848'],
        _uniqueKey: 3
      },
      {
        key: 4,
      ...
      {
        key: 6,
        matches: '[text="广告"] - ImageView < ViewGroup -(2) ViewGroup >(2) ImageView[id=null]',
        snapshotUrls: ['https://i.gkd.li/i/12700800'],
        _uniqueKey: 6
      },
      {
