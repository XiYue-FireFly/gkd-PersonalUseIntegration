  ...
  groups: [
{
      ...
      rules: [
      {
        ...
        matches: '[id="com.zzw.october:id/interact_ad_root"] >n ImageView[id="com.zzw.october:id/iv_close"]',
      ...
      },
      {
        ...
        matches: '@ImageView[clickable=true][width<90 && height<90] - [text="反馈"]',
      ...
      },
      {
        key: 6,
        matches: '[id="com.zzw.october:id/interact_ad_root"] >n ImageView[id="com.zzw.october:id/iv_close"]',
        snapshotUrls: ['https://i.gkd.li/i/12842675', 'https://i.gkd.li/i/12869369'],
        fastQuery: true,
        _uniqueKey: 6
      },
      ],
    },
{
      ...
      rules: [
      {
        ...
        snapshotUrls: ['https://i.gkd.li/i/19485921', 'https://i.gkd.li/i/19535009'],
        exampleUrls: 'https://e.gkd.li/f80b0ecb-a704-495d-9afc-c1ffcba2108f',
        fastQuery: true,
        anyMatches: ['[vid="dialog_de"][visibleToUser=true]', '[text="以后再说"][visibleToUser=true]'],
        _uniqueKey: 0
      },
      ],
    },
