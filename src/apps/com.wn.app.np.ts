    ...
    rules: [
      {
          ...
          exampleUrls: 'https://m.gkd.li/57941037/b75f4ba1-7e40-4ea2-9f65-20b61f018720',
          snapshotUrls: 'https://i.gkd.li/i/14722550',
      },
      { key: 0, matches: '[id="android:id/content"] >n FrameLayout[index=2][childCount=1] > ImageView' },
    ],
  }
  ],
});
