  ...
  groups: [
{
    ...
    rules: [
      ...
      { key: 0, matches: '@[id="com.eastmoney.android.berlin:id/tv_update_next_time"] + [id="com.eastmoney.android.berlin:id/tv_update_now"]' },
    ],
  },
{
    key: 2,
  ...
  },
{
    ...
    rules: [
      {
          activityIds: 'com.eastmoney.android.module.launcher.internal.home.HomeActivity',
          matches: '[id="com.eastmoney.android.berlin:id/push_on_notify_delete"]',
          snapshotUrls: 'https://i.gkd.li/i/12706065',
      },
      { key: 0, matches: '[id="com.eastmoney.android.berlin:id/push_on_notify_on"] + [id="com.eastmoney.android.berlin:id/push_on_notify_delete"]' },
    ],
  }
  ],
});
