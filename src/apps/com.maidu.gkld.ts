  ...
  groups: [
{
    ...
    rules: [
      ...
      { key: 0, matches: '[id="com.maidu.gkld:id/fl_float"] + [id="com.maidu.gkld:id/close_image_view"]' },
    ],
  },
{
    key: 10,
    ...
    rules: [
      ...
      { key: 0, matches: '[id="com.maidu.gkld:id/ll_open_app_notice"] + [id="com.maidu.gkld:id/iv_cancel"]' },
    ],
  }
  ],
});
