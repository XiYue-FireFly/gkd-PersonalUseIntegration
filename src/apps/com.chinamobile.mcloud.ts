  ...
  groups: [
{
    ...
    rules: [
      ...
      { key: 0, matches: '@[id="com.chinamobile.mcloud:id/bn_cancel"] + [id="com.chinamobile.mcloud:id/upgrade_title"]' },
    ],
  },
{
    key: 2,
  ...
  },
{
    ...
    rules: [
      ...
      { key: 0, matches: '[text="开启自动备份"] +n [id="com.chinamobile.mcloud:id/tv_skip"]' },
    ],
  },
{
    key: 5,
    ...
    rules: [
      ...
      { key: 0, matches: '[vid="btn_push_notice_close_dialog"]' },
    ],
  }
  ],
});
