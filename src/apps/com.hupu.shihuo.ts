  ...
  groups: [
{
    ...
    rules: [
      ...
      { key: 0, matches: '[text^="通知分类"] +n ImageView[id="com.hupu.shihuo:id/ivClose"]' },
    ],
  },
{
    key: 3,
    ...
    rules: [
      ...
      { key: 0, matches: '[id="com.hupu.shihuo:id/fragment_container"] >11 @ViewGroup[clickable=true] > ImageView' },
    ],
  },
{
    key: 4,
