  ...
  groups: [
{
      ...
      {
        key: 0,
        matches: ['[vid="ll_load"][visibleToUser=true]', '[vid="skip"][visibleToUser=true]'],
    ...
    },
{
      ...
      rules: [
      {
        ...
        matches: ['[vid="tip_view_pager"][visibleToUser=true]', '[vid="close"][visibleToUser=true]'],
        snapshotUrls: ['https://i.gkd.li/i/12726961', 'https://i.gkd.li/i/20649291'],
        fastQuery: true,
        _uniqueKey: 0
      },
      {
      ...
      {
        key: 2,
        matches: '[id="com.chinamworld.main:id/indicator_container_container"] + [id="com.chinamworld.main:id/close"]',
        _uniqueKey: 2
      },
      ],
    },
