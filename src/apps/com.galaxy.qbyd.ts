  ...
  groups: [
{
      ...
      rules: [
      {
        key: 0,
        name: '腾讯广告',
        activityIds: ['com.bytedance.sdk.openadsdk.stub.activity.Stub_Standard_Activity_T', 'com.aster.comic.app.view.MainActivity'],
        ...
        snapshotUrls: ['https://i.gkd.li/i/13691104', 'https://i.gkd.li/i/13691103'],
        fastQuery: true,
        _uniqueKey: 0
      },
      {
