  ...
  groups: [
{
    ...
    rules: [
      ...
      { key: 0, matches: '[id="com.huatu.handheld_huatu:id/main_img_adv_bg"] + [id="com.huatu.handheld_huatu:id/main_img_close"]' },
    ],
  },
{
    key: 10,
    ...
    rules: [
      ...
      { key: 0, matches: '[text*="开启通知提示"] +2 LinearLayout > [text="取消"]' },
    ],
  }
  ],
});
