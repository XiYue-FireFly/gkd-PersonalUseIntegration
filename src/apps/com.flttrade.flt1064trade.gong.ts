  ...
  groups: [
{
      ...
      {
        key: 2,
        matches: '@ImageView[childCount=0][text=null][desc=null][id=null][visibleToUser=true] < FrameLayout[childCount=1][text=null][desc=null][id=null] - FrameLayout[childCount>2] >3 [text^="立即" || text^="打开或下载" || text="了解更多" || text^="下载或打开"]',
      ...
      },
      {
        ...
        name: '腾讯广告-1',
        activityIds: 'com.flttrade.flt1064trade.gong.MainActivity',
        matches: ['ImageView - LinearLayout - FrameLayout > FrameLayout[childCount=1] > ImageView[childCount=0]', '[id="android:id/content"] >(4,5) @FrameLayout[index=1] > ImageView'],
        snapshotUrls: ['https://i.gkd.li/i/13759472', 'https://i.gkd.li/i/13798323', 'https://i.gkd.li/i/13798327'],
        _uniqueKey: 3,
        _uniqueName: '腾讯广告-1',
        name: '腾讯广告-1'
      },
