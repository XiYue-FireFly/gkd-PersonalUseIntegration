  ...
  groups: [
{
      ...
      {
        key: 0,
        activityIds: ['com.zhengnengliang.precepts.ui.activity.MainActivity', 'com.zhengnengliang.precepts.ui.dialog.DialogTwoButton'],
        ...
        snapshotUrls: ['https://i.gkd.li/i/12739767', 'https://i.gkd.li/i/12727705'],
      ...
      {
        key: 2,
        matches: '[text="点此去广告"] + ImageButton[clickable=true]',
        _uniqueKey: 2
      },
      ],
    },
