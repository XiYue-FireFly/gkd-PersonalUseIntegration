  ...
  groups: [
{
      ...
      },
      {
        key: 11,
        name: '优量汇-第二类广告',
        activityIds: ['com.zhizhou.days.activity.MainActivity', 'com.huawei.android.launcher.unihome.UniHomeLauncher'],
        ...
        snapshotUrls: ['https://i.gkd.li/i/12739703', 'https://i.gkd.li/i/12727546'],
        fastQuery: true,
        _uniqueKey: 11
      },
      {
        ...
        name: '优量汇-第一类广告-1',
        activityIds: 'com.zhizhou.days.activity.MainActivity',
        matches: 'ImageView - LinearLayout - FrameLayout > FrameLayout > ImageView[visibleToUser=true]',
        snapshotUrls: 'https://i.gkd.li/i/12727528',
        _uniqueKey: 12,
        _uniqueName: '优量汇-第一类广告-1',
        name: '优量汇-第一类广告-1'
      },
      {
        key: 13,
        name: '优量汇-第二类广告-1',
        activityIds: ['com.zhizhou.days.activity.MainActivity', 'com.huawei.android.launcher.unihome.UniHomeLauncher'],
        matches: 'ImageView - FrameLayout > FrameLayout > FrameLayout > ImageView[visibleToUser=true]',
        snapshotUrls: ['https://i.gkd.li/i/12739703', 'https://i.gkd.li/i/12727546'],
        _uniqueKey: 13,
        _uniqueName: '优量汇-第二类广告-1',
        name: '优量汇-第二类广告-1'
      },
      ],
    },
