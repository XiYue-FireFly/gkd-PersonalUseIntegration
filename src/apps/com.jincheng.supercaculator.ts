  ...
  groups: [
{
      ...
      rules: [
      {
        key: 0,
        name: '字节广告',
        activityIds: ['com.jincheng.supercaculator.activity.MainActivity', 'com.jincheng.supercaculator.activity.basic.CalculatorActivity'],
        matches: '@Image < View < View TextView[text = "反馈"]',
        snapshotUrls: ['https://i.gkd.li/i/12859523', 'https://i.gkd.li/i/12859545', 'https://i.gkd.li/i/13670598'],
        _uniqueKey: 0
      },
      {
        key: 1,
