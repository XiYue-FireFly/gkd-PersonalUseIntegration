  ...
  groups: [
{
    ...
    rules: [
      { key: 0, matches: '[desc^="开启系统通知"||desc^="开启消息通知"] > ImageView[clickable=true][desc=null]' },
      {
      ...
      { key: 0, matches: '[desc^="开启系统通知"] > ImageView[clickable=true][desc=null]' },
    ],
  },
{
    key: 2,
    ...
    rules: [
      { key: 0, matches: '[text*="开启个性化"] +n View[childCount=1] > Image[text.length>20]' },
      {
      ...
      { key: 0, matches: '@Button[text="取消"] <<n FrameLayout >n TextView[text*="手机信息"]' },
    ],
  },
{
    key: 3,
    ...
    rules: [
      {
          ...
          snapshotUrls: [
              'https://i.gkd.li/i/25619592',
              'https://i.gkd.li/i/25620240',
          ],
      },
      {
          key: 1,
      ...
      },
      {
          ...
          snapshotUrls: [
              'https://i.gkd.li/i/25619659',
              'https://i.gkd.li/i/25620267',
          ],
      },
    ],
  },
