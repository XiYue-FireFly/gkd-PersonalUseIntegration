  ...
  groups: [
{
      ...
      {
        key: 0,
        activityIds: ['com.klcxkj.zqxy.ui.main.MainActivity', 'com.anythink.basead.ui.ATPortraitTranslucentActivity'],
        matches: '[id="com.klcxkj.zqxy:id/anythink_myoffer_btn_close_id"]',
        snapshotUrls: ['https://i.gkd.li/i/13195649', 'https://i.gkd.li/i/12781415'],
        _uniqueKey: 0
      },
      {
        key: 1,
        ...
        matches: '@ImageView[childCount=0][text=null][desc=null][id=null][visibleToUser=true] < FrameLayout[childCount=1][text=null][desc=null][id=null][parent.childCount>3] +n FrameLayout >(1,2) [text^="立即" || text="查看详情" || text="了解更多" || text="去微信看看" || text^="打开或下载" || text="进入小程序" || text="领取优惠" || text="跳转微信" || text^="下载或打开"]',
        snapshotUrls: ['https://i.gkd.li/i/12781461', 'https://i.gkd.li/i/13488673', 'https://i.gkd.li/i/13546464', 'https://i.gkd.li/i/13071301', 'https://i.gkd.li/i/13707849'],
        fastQuery: true,
        _uniqueKey: 1
      },
      {
        ...
        matches: '@ViewGroup[clickable=true] < ViewGroup +2 ViewGroup > [text$="广告"]',
      ...
      },
      {
        key: 2,
        name: '腾讯广告-1',
        activityIds: ['com.klcxkj.zqxy.ui.main.MainActivity', 'com.klcxkj.zqxy.ui.device.apartment.ble.BathingBleActivity'],
        matches: 'FrameLayout[childCount>1] > FrameLayout[childCount=1] > ImageView[width<90][height<90]',
        snapshotUrls: ['https://i.gkd.li/i/12781461', 'https://i.gkd.li/i/13488673', 'https://i.gkd.li/i/13546464', 'https://i.gkd.li/i/13071301', 'https://i.gkd.li/i/13274836', 'https://i.gkd.li/i/13274836', 'https://i.gkd.li/i/13707849'],
        _uniqueKey: 2,
        _uniqueName: '腾讯广告-1',
        name: '腾讯广告-1'
      },
    ...
    },
{
      ...
      {
        key: 0,
        activityIds: 'com.klcxkj.zqxy.ui.device.drink.ble.DrinkingBleActivity',
      ...
      },
      {
        key: 1,
        activityIds: ['com.klcxkj.zqxy.ui.device.drink.ble.DrinkingBleActivity'],
        matches: '[id="com.klcxkj.zqxy:id/bathing_adv_layout"] >n FrameLayout[childCount=1] > ImageView',
        snapshotUrls: ['https://i.gkd.li/i/13488870'],
        _uniqueKey: 1
      },
      ],
