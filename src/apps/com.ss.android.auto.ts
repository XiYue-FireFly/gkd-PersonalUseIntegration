  ...
  },
{
    ...
    rules: [
      ...
      { key: 0, matches: '@TextView[text="以后再说"] - FrameLayout >2 TextView[text$="升级"]' },
    ],
  },
{
    key: 3,
    ...
    rules: [
      ...
      { key: 0, matches: 'FrameLayout > RelativeLayout[childCount=2] > RelativeLayout + ImageView[clickable=true]' },
    ],
  },
{
    key: 4,
    ...
    rules: [
      ...
      { key: 0, matches: 'FrameLayout > RelativeLayout > @ImageView[clickable=true] + [text="广告"]' },
    ],
  },
{
    key: 5,
    ...
    rules: [
      ...
      { key: 0, matches: 'FrameLayout > * > @ImageView[clickable=true] - LinearLayout > [text="广告"]' },
    ],
  },
{
    key: 6,
    ...
    rules: [
      ...
      { key: 0, matches: '@TextView[clickable=true] + [text^="打开推送通知"]' },
    ],
  },
{
    key: 7,
    ...
    rules: [
      ...
      { key: 0, matches: 'TextView[text.length=1][id=null][clickable=false] < @FrameLayout[clickable=true][id!=null] -2 [text="广告"]' },
    ],
  },
{
    key: 8,
