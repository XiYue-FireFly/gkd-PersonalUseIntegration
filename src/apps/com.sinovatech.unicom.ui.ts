  ...
  groups: [
{
      ...
      {
        key: 0,
        activityIds: ['com.sinovatech.unicom.basic.ui.activity.MainActivity', 'com.sinovatech.unicom.basic.ui.activity.WelcomeClient'],
        matches: '[text="去开启"] - [vid="custom_dialog_cancel_button"]',
        snapshotUrls: ['https://i.gkd.li/i/13331268', 'https://i.gkd.li/i/14751210'],
        _uniqueKey: 0
      },
      {
        key: 1,
    ...
    },
{
      ...
      },
      {
        ...
        snapshotUrls: ['https://i.gkd.li/i/15971964', 'https://i.gkd.li/i/18290899'],
        _uniqueKey: 1
      },
      {
        key: 2,
    ...
    },
{
      ...
      },
      {
        ...
        snapshotUrls: ['https://i.gkd.li/i/13930543', 'https://i.gkd.li/i/23141106'],
        fastQuery: true,
        _uniqueKey: 1
      },
      {
