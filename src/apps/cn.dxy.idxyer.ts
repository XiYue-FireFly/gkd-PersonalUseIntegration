  ...
  groups: [
{
      ...
      rules: [
      {
        ...
        snapshotUrls: ['https://i.gkd.li/i/24851243', 'https://i.gkd.li/i/24868496'],
        fastQuery: true,
        _uniqueKey: 0
      },
      {
    ...
    },
{
      ...
      rules: [
      {
        ...
        snapshotUrls: ['https://i.gkd.li/i/24852395', 'https://i.gkd.li/i/24852398'],
        fastQuery: true,
        _uniqueKey: 0
      },
      {
    ...
    },
{
      ...
      rules: [
      {
        key: 1,
        name: '点击查看答案按钮',
        activityIds: ['.biz.post.PostDetailActivity', '.biz.post.CommentDetailActivity'],
        matches: ['@Button[text=" 查看答案"][clickable=true][visibleToUser=true]'],
        snapshotUrls: ['https://i.gkd.li/i/24857800', 'https://i.gkd.li/i/24864724'],
        action: 'clickCenter',
