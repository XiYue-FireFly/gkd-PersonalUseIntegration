    ...
    rules: [
      {
          ...
          snapshotUrls: [
              ...
              'https://i.gkd.li/i/13197454',
          ],
      },
      { key: 0, matches: '[id="com.oray.sunlogin:id/close"][text="关闭"]' },
    ],
  },
{
    key: 1,
  ...
  },
{
    ...
    rules: [
      ...
      { key: 0, matches: '[id="com.oray.sunlogin:id/fl_close_advertise"]' },
    ],
  },
{
    key: 3,
    ...
    rules: [
      ...
      { key: 0, matches: '[text="是否确认退出向日葵？"] + LinearLayout > [vid="button_ok"]' },
    ],
  },
{
    key: 4,
