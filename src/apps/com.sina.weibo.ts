  ...
  groups: [
{
      ...
      {
        key: 0,
        matches: '[id="com.sina.weibo:id/rl_account_title_bar"] > [id="com.sina.weibo:id/tv_title_bar_skip"][text="跳过"]',
        _uniqueKey: 0
      },
      ],
    },
{
      ...
      fastQuery: true,
      snapshotUrls: ['https://i.gkd.li/i/12531433', 'https://i.gkd.li/i/12531434'],
      rules: [
      {
        key: 0,
        matches: '[id="com.sina.weibo:id/tv_option"&&text="取消勾选"]',
        _uniqueKey: 0
      },
      {
        key: 1,
        matches: '[id="com.sina.weibo:id/new_next_btn"&&text="进入微博（已选0个）"]',
        _uniqueKey: 1
      },
      ],
    },
    ...
    },
{
      ...
      rules: [
      {
        ...
        snapshotUrls: ['https://i.gkd.li/i/12674498', 'https://i.gkd.li/i/13035647'],
        _uniqueKey: 0
      },
      {
        key: 1,
        activityIds: ['com.sina.weibo.utils.WeiboDialog$CustomDialog', 'com.sina.weibo.feed.DetailWeiboActivity'],
        matches: 'TextView[text="不感兴趣"]',
        snapshotUrls: ['https://i.gkd.li/i/12674511', 'https://i.gkd.li/i/12929591'],
        preKeys: 0,
        _uniqueKey: 1
      },
      ],
    },
{
      ...
      {
        key: 0,
        matches: '[id="com.sina.weibo:id/tvGuide"] + [id="com.sina.weibo:id/v_close"] + [id="com.sina.weibo:id/iv_close"]',
        _uniqueKey: 0
      },
      ],
    },
{
      ...
      rules: [
      {
        ...
        snapshotUrls: ['https://i.gkd.li/i/14969848', 'https://i.gkd.li/i/16944794', 'https://i.gkd.li/i/19807700'],
        _uniqueKey: 3
      },
      {
        key: 4,
    ...
    },
{
      ...
      {
        key: 1,
        matches: '@[id="com.sina.weibo:id/bt_cancel"][text="暂不开启"] + [id="com.sina.weibo:id/bt_confirm"]',
        _uniqueKey: 1
      },
      ],
    },
{
      ...
      {
        key: 0,
        matches: '[text^="打开通知"] < LinearLayout + ImageView[id="com.sina.weibo:id/right_icon"]',
        _uniqueKey: 0
      },
      ],
    },
{
      ...
      {
        key: 0,
        matches: '[id="com.sina.weibo:id/ll_check_in_container"] < FrameLayout - FrameLayout > TextView + [id="com.sina.weibo:id/v_close"]',
        _uniqueKey: 0
      },
      ],
    },
    ...
    },
{
      ...
      rules: [
      {
        ...
        snapshotUrls: ['https://i.gkd.li/i/13218093', 'https://i.gkd.li/i/13003311'],
        _uniqueKey: 0
      },
      {
        key: 1,
    ...
    },
{
      ...
      activityIds: ['.feed.DetailWeiboActivity', '.feed.detailrefactor.DetailPageActivity', '.feed.SubCommentActiity', '.feed.halfcontainer.HalfContainerPageActivity'],
      fastQuery: true,
      rules: [
      {
        key: 0,
        matches: '@[vid="ll_close"] > [text="广告"][visibleToUser=true]',
        snapshotUrls: ['https://i.gkd.li/i/13852321', 'https://i.gkd.li/i/19526000', 'https://i.gkd.li/i/21828244', 'https://i.gkd.li/i/24291704'],
        _uniqueKey: 0
      },
      {
        key: 1,
      ...
      {
        key: 3,
        matches: ['[vid="left_img_ad_container"][visibleToUser=true]', '[vid="close"][visibleToUser=true]'],
        snapshotUrls: ['https://i.gkd.li/i/13635551', 'https://i.gkd.li/i/19525985'],
        _uniqueKey: 3
      },
      {
        key: 4,
      ...
      },
      {
        ...
        snapshotUrls: ['https://i.gkd.li/i/21166775', 'https://i.gkd.li/i/21828269'],
        exampleUrls: 'https://e.gkd.li/fc3b2c98-4540-4ec1-94b2-24abf90212c9',
        _uniqueKey: 6
      },
      {
        key: 90,
        snapshotUrls: ['https://i.gkd.li/i/13852322', 'https://i.gkd.li/i/13958782', 'https://i.gkd.li/i/16785777', 'https://i.gkd.li/i/14730274', 'https://i.gkd.li/i/19551451', 'https://i.gkd.li/i/20710958', 'https://i.gkd.li/i/21828246'],
        preKeys: [0,1,3,4,5,6],
        matchRoot: true,
        anyMatches: ['[text$="不感兴趣"][clickable=true]', '@LinearLayout[clickable=true] >2 [text="不感兴趣" || text="不想看到此类内容"]'],
        _uniqueKey: 90
      },
      {
        key: 2,
      ...
      },
      {
        ...
        activityIds: 'com.sina.weibo.feed.DetailWeiboActivity',
        matches: '[vid="corner_marker_view"] >2 [vid="right_top_tag"]',
        snapshotUrls: ['https://i.gkd.li/i/12673051', 'https://i.gkd.li/i/14210775'],
        _uniqueKey: 7
      },
      {
        key: 8,
        ...
        snapshotUrls: ['https://i.gkd.li/i/14729705', 'https://i.gkd.li/i/14753916'],
        _uniqueKey: 8
      },
      {
        key: 91,
    ...
    },
{
      ...
      rules: [
      {
        ...
        matches: ['ViewGroup[childCount=2] > [text="管理"][visibleToUser=true]', '[text="签到" || text="Sign in"] < [vid="right_button"][visibleToUser=true]'],
        snapshotUrls: ['https://i.gkd.li/i/15092999', 'https://i.gkd.li/i/15092970', 'https://i.gkd.li/i/15136801'],
        _uniqueKey: 0
      },
      {
        key: 1,
      ...
      },
      {
        ...
        snapshotUrls: ['https://i.gkd.li/i/15103524', 'https://i.gkd.li/i/15136825', 'https://i.gkd.li/i/15136842'],
        _uniqueKey: 2
      },
      {
        key: 3,
        matches: '[vid="container"] >n [text="close"]',
        _uniqueKey: 3
      },
      ],
    },
    ...
    },
{
      ...
      rules: [
      {
        ...
        matches: ['[text*="一键签到"][visibleToUser=true]', '[vid="checkinBtn"][visibleToUser=true]'],
    ...
    },
{
      ...
      name: '分段广告-评论区博主内容推荐',
      desc: '点击关闭-点击[不感兴趣]/[不想看到此类内容]',
      activityIds: ['.feed.detailrefactor.DetailPageActivity', '.story.gallery.feed.StoryFeedCommentsActivity2'],
      fastQuery: true,
      rules: [
      {
        key: 0,
        matches: '@[vid="ll_close"] > [text="推荐"][visibleToUser=true]',
        snapshotUrls: ['https://i.gkd.li/i/19551850', 'https://i.gkd.li/i/19552278'],
        _uniqueKey: 0
      },
      {
        key: 1,
        matches: '[text$="不感兴趣"][clickable=true]',
        snapshotUrls: ['https://i.gkd.li/i/19551857', 'https://i.gkd.li/i/19552282', 'https://i.gkd.li/i/24211723'],
        preKeys: [0],
        matchRoot: true,
        _uniqueKey: 1
      },
    ...
    },
{
      key: 27,
      name: '分段广告-评论区荐读',
      activityIds: ['.feed.detailrefactor.DetailPageActivity', '.feed.DetailWeiboActivity', '.feed.halfcontainer.HalfContainerPageActivity'],
      fastQuery: true,
      rules: [
      {
        key: 0,
        matches: '@[vid="ll_close"] > [text="荐读"][visibleToUser=true]',
        snapshotUrls: ['https://i.gkd.li/i/21828298', 'https://i.gkd.li/i/24237728', 'https://i.gkd.li/i/24291674'],
