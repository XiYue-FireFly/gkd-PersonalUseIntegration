  ...
  groups: [
{
    ...
    rules: [
      { key: 0, matches: '[id="com.sina.weibo:id/rl_account_title_bar"] > [id="com.sina.weibo:id/tv_title_bar_skip"][text="跳过"]' },
    ],
  },
{
    key: 4,
    ...
    rules: [
      { key: 0, matches: '[id="com.sina.weibo:id/tv_option"&&text="取消勾选"]' },
      { key: 0, matches: '[id="com.sina.weibo:id/new_next_btn"&&text="进入微博（已选0个）"]' },
    ],
  },
{
    key: 5,
  ...
  },
{
    ...
    rules: [
      { key: 0, matches: '[id="com.sina.weibo:id/tvGuide"] + [id="com.sina.weibo:id/v_close"] + [id="com.sina.weibo:id/iv_close"]' },
    ],
  },
{
    key: 8,
  ...
  },
{
    ...
    rules: [
      ...
      { key: 0, matches: '@[id="com.sina.weibo:id/bt_cancel"][text="暂不开启"] + [id="com.sina.weibo:id/bt_confirm"]' },
    ],
  },
{
    key: 10,
    ...
    rules: [
      { key: 0, matches: '[text^="打开通知"] < LinearLayout + ImageView[id="com.sina.weibo:id/right_icon"]' },
    ],
  },
{
    key: 11,
    ...
    rules: [
      { key: 0, matches: '[id="com.sina.weibo:id/ll_check_in_container"] < FrameLayout - FrameLayout > TextView + [id="com.sina.weibo:id/v_close"]' },
    ],
  },
{
    key: 13,
  ...
  },
{
    ...
    rules: [
      ...
      { key: 0, matches: '@[text="不了，谢谢"] +4 [text="喜欢，给好评"]' },
    ],
  },
{
    key: 19,
  ...
  },
{
    ...
    rules: [
      ...
      { key: 0, matches: '[vid="container"] >n [text="close"]' },
    ],
  },
{
    key: 21,
