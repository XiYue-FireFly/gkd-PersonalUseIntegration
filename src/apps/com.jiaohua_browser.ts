  ...
  groups: [
{
    ...
    snapshotUrls: [
      ...
      'https://i.gkd.li/i/14142408',
    ],
    rules: [
      { key: 0, matches: '@ViewGroup > [text=""][visibleToUser=true]' },
    ],
  },
{
    key: 1,
  ...
  },
{
    ...
    rules: [
      ...
      { key: 0, matches: '@ViewGroup > [text="立即簽到"][visibleToUser=true]' },
    ],
  },
{
    key: 4,
