  ...
  groups: [
{
      ...
      },
      {
        ...
        snapshotUrls: ['https://i.gkd.li/i/13302326', 'https://i.gkd.li/i/13313576', 'https://i.gkd.li/i/13313624', 'https://i.gkd.li/i/13313576'],
        fastQuery: true,
        _uniqueKey: 2
      },
      {
        ...
        matches: '@Image[childCount=0][text=""] < View[childCount=1] + View[childCount=1][text=""] +n View >(1,2) View[childCount=1] > [text$="广告"]',
        snapshotUrls: ['https://i.gkd.li/i/12925095', 'https://i.gkd.li/i/12925052'],
        _uniqueKey: 4
      },
      {
        key: 3,
        matches: 'TextView < LinearLayout[childCount=2] < FrameLayout[childCount=2] > FrameLayout[childCount=1] > ImageView',
        snapshotUrls: 'https://i.gkd.li/i/13274336',
        _uniqueKey: 3
      },
      {
        key: 5,
        matches: ['[text^="立即" || text^="查看" || text^="领取"][text.length=4]', '[id="android:id/content"] >2 FrameLayout[childCount=3||childCount=2] > FrameLayout[childCount=5||childCount=6||childCount=8] > FrameLayout[childCount=1] > ImageView[text=null][visibleToUser=true]'],
        snapshotUrls: ['https://i.gkd.li/i/13302326', 'https://i.gkd.li/i/13313576', 'https://i.gkd.li/i/13313624', 'https://i.gkd.li/i/13313576'],
        _uniqueKey: 5
      },
      {
