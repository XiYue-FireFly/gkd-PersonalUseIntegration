  ...
  },
{
    ...
    rules: [
      ...
      { key: 0, matches: '[text*="开启通知"] < FrameLayout + FrameLayout >2 [text="取消"]' },
    ],
  },
{
    key: 9,
    ...
    rules: [
      ...
      { key: 0, matches: '[text="系统定位服务已关闭"] < FrameLayout +n FrameLayout >2 [text="取消"]' },
    ],
  },
{
    key: 10,
  ...
  },
{
    ...
    rules: [
      { key: 0, matches: '@[id="com.jingyao.easybike:id/closeFloatArea"] + [id="com.jingyao.easybike:id/floatADContainer"]' },
    ],
  },
{
    key: 15,
    ...
    rules: [
      ...
      { key: 0, matches: '@View[text="跳过"] <2 View <2 View <<n FrameLayout[id="com.jingyao.easybike:id/h5_pc_container"]' },
    ],
  }
  ],
});
