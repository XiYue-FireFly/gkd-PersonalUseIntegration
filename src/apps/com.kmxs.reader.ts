  ...
  groups: [
{
    ...
    rules: [
      ...
      { key: 0, matches: '[id="com.kmxs.reader:id/ll_ad_native_banner"] > [id="com.kmxs.reader:id/iv_ad_direct_close"]' },
    ],
  },
{
    key: 3,
  ...
  },
{
    ...
    activityIds: 'org.geometerplus.android.fbreader.FBReader',
    snapshotUrls: [
      'https://i.gkd.li/i/12640320',
    ],
    rules: [
      { key: 0, matches: '@TextView[id=null] < View +(2) TextView[text^="已连签"&&text*="天"]' },
    ],
  },
{
    key: 5,
  ...
  },
{
    ...
    rules: [
      ...
      { key: 0, matches: '[id="com.kmxs.reader:id/bookshelf_book_item_direct_close"]' },
    ],
  },
{
    key: 9,
