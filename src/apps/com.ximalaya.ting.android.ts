  ...
  groups: [
{
    ...
    rules: [
      { key: 0, matches: '[id="com.ximalaya.ting.android:id/main_ad_broadside_close_real"]' },
    ],
  },
{
    key: 1,
  ...
  },
{
    ...
    rules: [
      { key: 0, matches: '[id="com.ximalaya.ting.android:id/main_play_ad_close_real"]' },
    ],
  },
{
    key: 4,
  ...
  },
{
    ...
    rules: [
      { key: 0, matches: '[id="com.ximalaya.ting.android:id/host_tv_update_later"]' },
    ],
  },
{
    key: 7,
  ...
  },
{
    ...
    rules: [
      { key: 0, matches: '[id="com.ximalaya.ting.android:id/main_ad_close_real"][visibleToUser=true]' },
    ],
  },
{
    key: 9,
  ...
  },
{
    ...
    rules: [
      ...
      { key: 0, matches: '[text="你可能感兴趣的专辑"] + [id="com.ximalaya.ting.android:id/main_iv_close"]' },
    ],
  },
{
    key: 11,
    ...
    rules: [
      ...
      { key: 0, matches: '@[id="com.ximalaya.ting.android:id/host_close_firework"] +2 [id="com.ximalaya.ting.android:id/host_firework_ad_tag"]' },
    ],
  },
{
    key: 12,
  ...
  },
{
    ...
    rules: [
      ...
      { key: 0, matches: '[id="com.ximalaya.ting.android:id/main_iv_close"]' },
    ],
  },
{
    key: 14,
    ...
    rules: [
      { key: 0, matches: '[id="com.ximalaya.ting.android:id/main_iv_dislike"]' },
    ],
  }
  ],
});
