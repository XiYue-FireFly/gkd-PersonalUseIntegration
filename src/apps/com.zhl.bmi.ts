  ...
  groups: [
{
      ...
      rules: [
      {
        ...
        snapshotUrls: ['https://i.gkd.li/i/13255787', 'https://i.gkd.li/i/13255786'],
        _uniqueKey: 0
      },
      {
        key: 1,
      ...
      {
        key: 2,
        matches: '@ImageView < FrameLayout[childCount=1] <(2,3) FrameLayout <(1,2) FrameLayout < FrameLayout < [id="android:id/content"]',
        _uniqueKey: 2
      },
      ],
    },
