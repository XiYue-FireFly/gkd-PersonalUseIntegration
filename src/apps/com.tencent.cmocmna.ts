    ...
    rules: [
      {
          ...
          snapshotUrls: [
              ...
              'https://i.gkd.li/i/13063271',
          ],
      },
      { key: 0, matches: 'ViewGroup[childCount=2] > @ImageView[id!=null][clickable=true] + ImageView' },
    ],
  },
{
    key: 2,
    ...
    rules: [
      ...
      { key: 0, matches: 'ImageView - ViewGroup > ImageView + ImageView + ImageView' },
    ],
  }
  ],
});
