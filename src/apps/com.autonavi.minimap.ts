  ...
  },
{
    ...
    rules: [
      { key: 0, matches: 'ImageView[visibleToUser=true][width<90][height<90] < @ViewGroup -(2) ViewGroup > ViewGroup > View[text*="签到"||text*="成长值"]' },
    ],
  },
{
    key: 4,
    ...
    rules: [
      { key: 0, matches: '[text="分享截图至"] < ViewGroup < ViewGroup + @ViewGroup[clickable=true] > ImageView' },
      {
          fastQuery: true,
          activityIds: 'com.autonavi.map.activity.NewMapActivity',
  ...
  },
{
    ...
    rules: [
      ...
      { key: 0, matches: 'RelativeLayout[desc="弹窗"] > [id="com.autonavi.minimap:id/msgbox_popup_clear"]' },
    ],
  },
{
    key: 11,
  ...
  },
{
    ...
    rules: [
      ...
      { key: 0, matches: '@ImageView < [desc="关闭"][clickable=true] - ViewGroup > ViewGroup > ViewGroup > View[text="立即领取"]' },
    ],
  },
{
    key: 13,
