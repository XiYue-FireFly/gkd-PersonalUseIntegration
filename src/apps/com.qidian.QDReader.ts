  ...
  },
{
    ...
    rules: [
      ...
      { key: 0, matches: '[id="com.qidian.QDReader:id/imgBKT"] + [id="com.qidian.QDReader:id/imgClose"]' },
    ],
  },
{
    key: 4,
    ...
    rules: [
      ...
      { key: 0, matches: '@[id="com.qidian.QDReader:id/ivClose"] + [text^="开启推送"]' },
    ],
  },
{
    key: 5,
  ...
  },
{
    ...
    rules: [
      ...
      { key: 0, matches: 'View[desc="更多游戏"] - ImageView[clickable=true]' },
    ],
  },
{
    key: 12,
    ...
    rules: [
      {
          ...
          snapshotUrls: [
              'https://i.gkd.li/i/13606901',
              'https://i.gkd.li/i/22909666',
              'https://i.gkd.li/i/24339296',
          ],
      },
      { key: 0, matches: 'View[desc="我知道了"]' },
    ],
  },
{
    key: 13,
