  ...
  },
{
    ...
    rules: [
      ...
      { key: 0, matches: '[id="com.chinatelecom.bestpayclient:id/best_h5_container"] View[childCount=2] > @View[clickable=true] +  View[clickable=true] > Image[text!=null]' },
    ],
  },
{
    key: 5,
    ...
    rules: [
      {
          ...
          snapshotUrls: [
              ...
              'https://i.gkd.li/i/13625037',
          ],
      },
      { key: 0, matches: 'View > View[index=1][clickable=true][childCount=1] > Image' },
    ],
  },
{
    key: 6,
