  ...
  groups: [
{
    ...
    rules: [
      ...
      { key: 0, matches: '[id="gov.pianzong.androidnga:id/iv_tg_ad"]' },
      { key: 0, matches: '[id="gov.pianzong.androidnga:id/ksad_splash_circle_skip_view"]' },
      { key: 0, matches: '[id="gov.pianzong.androidnga:id/ksad_skip_view_skip"]' },
      { key: 0, matches: '[vid="tv_tiaoguo"]' },
      { key: 0, matches: '[text*="跳过"][text.length<=5]' },
    ],
  },
{
    key: 1,
    ...
    rules: [
      ...
      { key: 0, matches: '[id="gov.pianzong.androidnga:id/iv_close_ad"]' },
    ],
  },
{
    key: 2,
    ...
    rules: [
      {
          ...
          snapshotUrls: [
              'https://i.gkd.li/i/12706132',
          ],
      },
      { key: 0, matches: '[id="gov.pianzong.androidnga:id/iv_close_community_ad"]' },
    ],
  },
{
    key: 4,
