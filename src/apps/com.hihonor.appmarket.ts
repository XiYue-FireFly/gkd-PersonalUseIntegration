  ...
  },
{
    ...
    rules: [
      ...
      { key: 0, matches: '[id="com.hihonor.appmarket:id/iv_dialog_operation_close"]' },
    ],
  },
{
    key: 2,
    ...
    rules: [
      ...
      { key: 0, matches: '[id="com.hihonor.appmarket:id/iv_floating_close"]' },
    ],
  },
{
    key: 3,
    ...
    rules: [
      ...
      { key: 0, matches: 'TextView[text="接收通知"] < LinearLayout < LinearLayout +n [id="android:id/buttonPanel"] Button[text="否"]' },
    ],
  },
{
    key: 4,
