  ...
  },
{
    ...
    rules: [
      ...
      { key: 0, matches: 'View[desc.length>0] +2n FrameLayout > TextView[text="퀺"]' },
    ],
  },
{
    key: 3,
  ...
  },
{
    ...
    rules: [
      { key: 0, matches: '@CheckBox[checked=true][checked=true] < * - [text~="开通(.*)免密支付"]' },
    ],
  },
{
    key: 8,
    ...
    rules: [
      { key: 0, matches: '@Image[childCount=0][visibleToUser=true][text!=null] <n View >(1,2) [visibleToUser=true][text*="消息通知" || text*="系统通知"] <<n [vid="poplayer_inner_view"]' },
      {
          activityIds: [
              'com.taobao.android.tbabilitykit.pop.StdPopContainerActivity',
              'com.taobao.tao.TBMainActivity',
      ...
      { key: 0, matches: '[text^="开启系统通知"] + @Image[visibleToUser=true] <<n [vid="poplayer_inner_view"]' },
    ],
  },
{
    key: 9,
    ...
    rules: [
      ...
      { key: 0, matches: 'TextView[text="去首页"] + TextView[text="退出"]' },
    ],
  },
{
    key: 10,
    ...
    rules: [
      { key: 0, matches: 'View[id=null] > [text="立即参加"] + TextView[id=null][clickable=true]' },
    ],
  },
{
    key: 11,
    ...
    rules: [
      { key: 0, matches: '@View[clickable=true] - View > View > TextView[text="立即签到"]' },
    ],
  },
{
    key: 12,
    ...
    rules: [
      { key: 0, matches: '[vid="update_imageview_cancel_v2"]' },
      {
          activityIds: [
              'com.taobao.android.detail.wrapper.activity.DetailActivity',
              'com.taobao.android.order.bundle.TBOrderListActivity',
  ...
  },
{
    ...
    rules: [
      ...
      { key: 0, matches: '@[text="关闭"] < * <3 * < * + * >3 [text$="小额免密支付"]' },
    ],
  },
{
    key: 14,
