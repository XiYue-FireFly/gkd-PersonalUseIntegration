  ...
  groups: [
{
      ...
      rules: [
      {
        ...
        excludeMatches: ['[!(vid="welcome_ad_view_skip")] > [text*="跳过"][text.length<10][width<500 && height<300][visibleToUser=true]', '@[desc="close_button"] - [text="|"][visibleToUser=true]'],
        snapshotUrls: 'https://i.gkd.li/i/18368988',
        exampleUrls: 'https://e.gkd.li/d14f7876-892f-4a25-aa1f-0f7500be52cb',
        fastQuery: true,
        excludeSnapshotUrls: ['https://i.gkd.li/i/18370963', 'https://i.gkd.li/i/21383354', 'https://i.gkd.li/i/23921822', 'https://i.gkd.li/i/23922767'],
        _uniqueKey: 0
      },
      {
        key: 1,
        matches: '[!(vid="welcome_ad_view_skip")] > [text*="跳过"][text.length<10][width<500 && height<300][visibleToUser=true]',
        snapshotUrls: ['https://i.gkd.li/i/21383354', 'https://i.gkd.li/i/23921822'],
