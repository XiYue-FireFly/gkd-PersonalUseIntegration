  ...
  groups: [
{
    ...
    rules: [
      ...
      { key: 0, matches: '[id="com.dw.btime:id/iv_overlay_close"][clickable=true]' },
    ],
  },
{
    key: 2,
    ...
    rules: [
      ...
      { key: 0, matches: '[id="com.dw.btime:id/old_baby_close"][clickable=true]' },
    ],
  },
{
    key: 3,
    ...
    rules: [
      ...
      { key: 0, matches: 'TextView[text="立即更新"] -3 [id="com.dw.btime:id/iv_upgrade_close"]' },
    ],
  }
  ],
});
