  ...
  },
{
    ...
    rules: [
      ...
      { key: 0, matches: '[vid="gallery_layout_below_category_view"] >3 [text="立即下载"] -n LynxFlattenUI[clickable=true]' },
    ],
  },
{
    key: 2,
    ...
    rules: [
      ...
      { key: 0, matches: '[vid="tv_title_resume_design"] +2 [vid="tvResumeNow"]' },
    ],
  }
  ],
});
