  ...
  },
{
    ...
    rules: [
      { key: 0, matches: 'ViewGroup + FrameLayout[id=null] > FrameLayout[childCount=2][id!=null] > ImageView[desc="关闭"][clickable=true][id!=null]' },
    ],
  },
{
    key: 5,
    ...
    rules: [
      { key: 0, matches: '[id="android:id/content"] >2 RelativeLayout[childCount<=5] > @ImageView[clickable=true][id!=null] - TextView[text="广告"][id!=null]' },
    ],
  },
{
    key: 6,
    ...
    rules: [
      { key: 0, matches: '@[text="取消"] +2 [text="五星好评"]' },
    ],
  },
{
    key: 7,
    ...
    rules: [
      { key: 0, matches: '@[text="拒绝"] + [text="去设置"]' },
    ],
  },
{
    key: 10,
    ...
    rules: [
      {
          ...
          snapshotUrls: [
              'https://i.gkd.li/i/18637952',
              'https://i.gkd.li/i/18637948',
          ],
      },
      { key: 0, matches: '[text="原图"][desc="未选中/复选框 原图"]' },
    ],
  },
{
    key: 12,
  ...
  },
{
    ...
    rules: [
      { key: 0, matches: 'FrameLayout > @[desc="关闭"] + ViewGroup > [text$="打个招呼"]' },
    ],
  },
{
    key: 15,
    ...
    rules: [
      ...
      { key: 0, matches: '@[text="不感兴趣"][clickable=true] + [text="去商城搜索更多"]' },
    ],
  },
{
    key: 16,
  ...
  },
{
    ...
    rules: [
      { key: 0, matches: '@[text="不感兴趣"][clickable=true] + [text="更多优惠商品"]' },
    ],
  },
{
    key: 19,
  ...
  },
{
    ...
    rules: [
      ...
      { key: 0, matches: '[text$="通讯录"] +2 FrameLayout >2 [text="拒绝"]' },
    ],
  },
{
    key: 21,
