  ...
  groups: [
{
    ...
    rules: [
      ...
      { key: 0, matches: '[text*="更新应用版本"]' },
      { key: 0, matches: '[text="取消"]' },
    ],
  },
{
    key: 2,
  ...
  },
{
    ...
    rules: [
      ...
      { key: 0, matches: 'bb Button[text="关闭"]' },
    ],
  },
{
    key: 6,
    ...
    rules: [
      ...
      { key: 0, matches: '@View + View >2 [text="买校园版超级吃货卡"]' },
    ],
  },
{
    key: 7,
    ...
    rules: [
      ...
      { key: 0, matches: '@ViewGroup[childCount=0][clickable=true] - ViewGroup[childCount=3] <<n [id="me.ele:id/id_magex_mist_view"]' },
    ],
  },
{
    key: 8,
  ...
  },
{
    ...
    rules: [
      { key: 0, matches: 'View >2 View[childCount=2] > @View[clickable=true] > Image' },
    ],
  }
  ],
});
