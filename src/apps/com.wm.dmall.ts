  ...
  groups: [
{
    ...
    rules: [
      ...
      { key: 0, matches: '[id="com.wm.dmall:id/advert_close"]' },
    ],
  },
{
    key: 2,
    ...
    rules: [
      ...
      { key: 0, matches: '@[id="com.wm.dmall:id/iv_close"] + [id="com.wm.dmall:id/view_float"]' },
      { key: 0, matches: '[id="com.wm.dmall:id/close_iV"]' },
    ],
  },
{
    key: 3,
