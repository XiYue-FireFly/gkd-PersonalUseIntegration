  ...
  },
{
    ...
    rules: [
      ...
      },
      {
          ...
          snapshotUrls: [
              'https://i.gkd.li/i/13206534',
              'https://i.gkd.li/i/13797001',
          ],
      },
      {
          key: 3,
  ...
  },
{
    ...
    rules: [
      ...
      { key: 0, matches: '[text="抢先体验"] -2 [text="不再提醒"]' },
    ],
  },
{
    key: 4,
  ...
  },
{
    ...
    rules: [
      ...
      { key: 0, matches: '[text*="好评"] <4 ViewGroup + [vid="close_btn"]' },
    ],
  },
{
    key: 7,
  ...
  },
{
    ...
    rules: [
      ...
      { key: 0, matches: '@[desc="关闭按钮"] <n * > [desc^="看广告"]' },
    ],
  },
{
    key: 9,
