  ...
  groups: [
{
      ...
      },
      {
        ...
        snapshotUrls: ['https://i.gkd.li/i/13334850', 'https://i.gkd.li/i/13446735'],
      ...
      },
      {
        key: 2,
        activityIds: '.ui.play.PlayerActivity',
        matches: 'ImageView[childCount=0] < @ViewGroup[clickable=true][childCount=1] < ViewGroup[childCount=1] <2 ViewGroup - ViewGroup >2 [text="广告"]',
      ...
      },
      {
        key: 3,
        activityIds: '.ui.play.PlayerActivity',
        matches: '@[id="cj.mobile.wm.allmodules:id/wm_express_close_iv"] - LinearLayout > [text="广告"]',
      ...
      },
      {
        key: 4,
        name: '局部广告',
        activityIds: ['com.github.eprendre.tingshu.ui.search.AggregateSearchActivity', 'com.github.eprendre.tingshu.ui.play.PlayerActivity'],
        matches: 'FrameLayout > FrameLayout[childCount=1] > ImageView[width<80][height<80]',
        snapshotUrls: ['https://i.gkd.li/i/12783466', 'https://i.gkd.li/i/13334850', 'https://i.gkd.li/i/13446735'],
        _uniqueKey: 4
      },
      {
        key: 5,
    ...
    },
{
      ...
      },
      {
        ...
        name: '快手广告-1',
        activityIds: 'com.github.eprendre.tingshu.ui.SplashActivity',
        matches: ['ViewGroup[childCount=2] > [text="广告"]', 'ViewGroup[childCount=3] > TextView + TextView + ImageView[clickable=true]'],
        snapshotUrls: 'https://i.gkd.li/i/13625303',
        _uniqueKey: 1,
        _uniqueName: '快手广告-1',
        name: '快手广告-1'
    ...
    },
{
      ...
      rules: [
      {
        key: 1,
        activityIds: '.ui.play.PlayerActivity',
        matches: '@[desc="close"][visibleToUser=true] + [desc="ad_logo"] <<n [vid="ad_container"]',
      ...
      },
      {
        key: 2,
        activityIds: '.ui.play.PlayerActivity',
        matches: '@[text="反馈"] <2 View + View >3 [visibleToUser=true][text="广告"] <<n [vid="ad_container"]',
      ...
      },
      {
        key: 3,
        activityIds: '.ui.play.PlayerActivity',
        matches: '@Image[childCount=0][visibleToUser=true][width<50 && height<50] < View[childCount=1] <n View >4 [visibleToUser=true][text="广告"] <<n [vid="ad_container"]',
        snapshotUrls: ['https://i.gkd.li/i/18058170', 'https://i.gkd.li/i/18095619'],
      ...
      {
        key: 4,
        activityIds: ['com.bytedance.sdk.openadsdk.stub.activity.Stub_Standard_Activity_T', '.ui.play.PlayerActivity'],
        matches: '@[clickable=true] > [text="不感兴趣"]',
        snapshotUrls: ['https://i.gkd.li/i/17892449', 'https://i.gkd.li/i/18057440', 'https://i.gkd.li/i/18058170'],
