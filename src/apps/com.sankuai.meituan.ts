  ...
  groups: [
{
    ...
    rules: [
      ...
      { key: 0, matches: 'TextView[text^="新版本"] - Button[id="com.sankuai.meituan:id/btn_close"]' },
    ],
  },
{
    key: 2,
    ...
    rules: [
      ...
      },
      {
          ...
          excludeSnapshotUrls: [
              'https://i.gkd.li/i/16487898',
              'https://i.gkd.li/i/20553947',
          ],
      },
      {
          key: 7,
  ...
  },
{
    ...
    rules: [
      ...
      { key: 0, matches: '[id="shareNav"] > [text=""]' },
    ],
  },
{
    key: 11,
