  ...
  },
{
    ...
    rules: [
      ...
      { key: 0, matches: '@[text="取消"] < * -2 * > [text="开启推送提醒"]' },
    ],
  },
{
    key: 12,
    ...
    snapshotUrls: 'https://i.gkd.li/i/13191156',
    rules: [
      { key: 0, matches: 'TextView[text="广告"] +2 Button[id="com.dragon.read:id/close"]' },
    ],
  },
{
    key: 13,
    ...
    rules: [
      { key: 0, matches: '[vid="container"] > ImageView' },
    ],
  },
{
    key: 14,
    ...
    rules: [
      { key: 0, matches: '[id="com.dragon.read:id/readFlowNonRoundEntranceLayout"] [id="com.dragon.read:id/relativeRight"]' },
    ],
  },
{
    key: 16,
    ...
    rules: [
      ...
      { key: 0, matches: '@ImageView[clickable=true] +3 * > [text="五星好评"]' },
    ],
  },
{
    key: 17,
    ...
    rules: [
      ...
      { key: 0, matches: '@UIImage[clickable=true] + [text="番茄VIP免费领"]' },
    ],
  },
{
    key: 19,
