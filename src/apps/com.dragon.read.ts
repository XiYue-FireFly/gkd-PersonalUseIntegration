...
export default defineGkdApp({
  ...
  groups: [
    ...
    },
    {
      ...
      activityIds: 'com.dragon.read.reader.ui.ReaderActivity',
      rules: '[id="com.dragon.read:id/readFlowNonRoundEntranceLayout"] [id="com.dragon.read:id/relativeRight"]',
    ...
    },
    {
      ...
      rules: [
        ...
        '@ImageView[clickable=true] +3 * > [text="五星好评"]',
      ],
    },
    {
      key: 17,
      ...
      rules: [
        ...
        '@UIImage[clickable=true] + [text="番茄VIP免费领"]',
      ],
    },
    {
      key: 19,
