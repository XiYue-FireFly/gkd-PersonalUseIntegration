  ...
  groups: [
{
      ...
      rules: [
      {
        ...
        snapshotUrls: ['https://i.gkd.li/i/12928975', 'https://i.gkd.li/i/13226636'],
        action: 'clickCenter',
        _uniqueKey: 0
      },
      {
        key: 1,
        matches: ['[id="com.huawei.android.totemweather:id/rl_splash_container"]', '[text.length<=4][text^="跳过"]'],
        snapshotUrls: ['https://i.gkd.li/i/12928975', 'https://i.gkd.li/i/13226636'],
        fastQuery: true,
        action: 'clickCenter',
        _uniqueKey: 1
    ...
    },
{
      ...
      {
        key: 0,
        activityIds: ['com.huawei.android.totemweather.WeatherMainActivity', 'com.huawei.android.totemweather.WeatherHome'],
        matches: '[vid="rl_close_pps" || vid="ad_cancel"][visibleToUser=true]',
        snapshotUrls: ['https://i.gkd.li/i/13521221', 'https://i.gkd.li/i/13787501', 'https://i.gkd.li/i/13800100', 'https://i.gkd.li/i/14278462', 'https://i.gkd.li/i/15831584'],
        _uniqueKey: 0
      },
      {
        key: 1,
      ...
      {
        key: 99,
        activityIds: ['com.huawei.openalliance.ad.activity.FeedbackActivity', '.news.main.content.ModulesActivity'],
        snapshotUrls: ['https://i.gkd.li/i/13259434', 'https://i.gkd.li/i/15831539', 'https://i.gkd.li/i/24688856'],
        preKeys: [0,1],
        anyMatches: ['[text="直接关闭"]', '@[clickable=true][text="直接关闭"] <<n [vid="content_main_view"]'],
        _uniqueKey: 99
      },
      {
        key: 3,
