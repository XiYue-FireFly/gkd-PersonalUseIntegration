    ...
    },
{
      ...
      rules: [
      {
        ...
        snapshotUrls: ['https://i.gkd.li/i/14766665', 'https://i.gkd.li/i/16438609'],
        fastQuery: true,
      ...
      {
        key: 1,
        matches: '[id="android:id/content"] >(3,4) View[childCount=2] >2 View[childCount=3] > ImageView[index=2][clickable=true]',
        _uniqueKey: 1
      },
      ],
    },
